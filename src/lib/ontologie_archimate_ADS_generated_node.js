...
const afn = {
	 ...
	 * @param {rdfs_Resource} arg1  the URI resource to get the local name of
	 * @returns {string}
	 */
	localname(arg1) {
	 ...
	 * @param {rdfs_Resource} arg1  the URI resource to get the namespace of
	 * @returns {string}
	 */
	namespace(arg1) {
...
/**
 * Generated from the namespace <http://bp4mc2.org/def/archimate#>
 */
const archimate = {

	/**
	 * Converts a value into an instance of archimate_ApplicationCollaboration
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ApplicationCollaboration} the converted node or null if the input was not a string or object
	 */
	asApplicationCollaboration: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ApplicationCollaboration(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ApplicationCollaboration
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ApplicationCollaboration[]} the converted nodes
	 */
	asApplicationCollaborationArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ApplicationCollaboration(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ApplicationComponent
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ApplicationComponent} the converted node or null if the input was not a string or object
	 */
	asApplicationComponent: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ApplicationComponent(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ApplicationComponent
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ApplicationComponent[]} the converted nodes
	 */
	asApplicationComponentArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ApplicationComponent(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ApplicationEvent
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ApplicationEvent} the converted node or null if the input was not a string or object
	 */
	asApplicationEvent: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ApplicationEvent(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ApplicationEvent
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ApplicationEvent[]} the converted nodes
	 */
	asApplicationEventArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ApplicationEvent(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ApplicationFunction
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ApplicationFunction} the converted node or null if the input was not a string or object
	 */
	asApplicationFunction: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ApplicationFunction(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ApplicationFunction
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ApplicationFunction[]} the converted nodes
	 */
	asApplicationFunctionArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ApplicationFunction(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ApplicationInteraction
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ApplicationInteraction} the converted node or null if the input was not a string or object
	 */
	asApplicationInteraction: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ApplicationInteraction(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ApplicationInteraction
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ApplicationInteraction[]} the converted nodes
	 */
	asApplicationInteractionArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ApplicationInteraction(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ApplicationInterface
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ApplicationInterface} the converted node or null if the input was not a string or object
	 */
	asApplicationInterface: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ApplicationInterface(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ApplicationInterface
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ApplicationInterface[]} the converted nodes
	 */
	asApplicationInterfaceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ApplicationInterface(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ApplicationProcess
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ApplicationProcess} the converted node or null if the input was not a string or object
	 */
	asApplicationProcess: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ApplicationProcess(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ApplicationProcess
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ApplicationProcess[]} the converted nodes
	 */
	asApplicationProcessArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ApplicationProcess(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ApplicationService
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ApplicationService} the converted node or null if the input was not a string or object
	 */
	asApplicationService: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ApplicationService(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ApplicationService
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ApplicationService[]} the converted nodes
	 */
	asApplicationServiceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ApplicationService(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ArchimateModelElement
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ArchimateModelElement} the converted node or null if the input was not a string or object
	 */
	asArchimateModelElement: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ArchimateModelElement(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ArchimateModelElement
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ArchimateModelElement[]} the converted nodes
	 */
	asArchimateModelElementArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ArchimateModelElement(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Artifact
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Artifact} the converted node or null if the input was not a string or object
	 */
	asArtifact: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Artifact(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Artifact
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Artifact[]} the converted nodes
	 */
	asArtifactArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Artifact(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Assessment
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Assessment} the converted node or null if the input was not a string or object
	 */
	asAssessment: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Assessment(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Assessment
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Assessment[]} the converted nodes
	 */
	asAssessmentArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Assessment(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessActor
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessActor} the converted node or null if the input was not a string or object
	 */
	asBusinessActor: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessActor(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessActor
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessActor[]} the converted nodes
	 */
	asBusinessActorArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessActor(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessCollaboration
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessCollaboration} the converted node or null if the input was not a string or object
	 */
	asBusinessCollaboration: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessCollaboration(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessCollaboration
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessCollaboration[]} the converted nodes
	 */
	asBusinessCollaborationArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessCollaboration(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessEvent
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessEvent} the converted node or null if the input was not a string or object
	 */
	asBusinessEvent: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessEvent(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessEvent
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessEvent[]} the converted nodes
	 */
	asBusinessEventArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessEvent(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessFunction
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessFunction} the converted node or null if the input was not a string or object
	 */
	asBusinessFunction: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessFunction(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessFunction
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessFunction[]} the converted nodes
	 */
	asBusinessFunctionArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessFunction(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessInteraction
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessInteraction} the converted node or null if the input was not a string or object
	 */
	asBusinessInteraction: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessInteraction(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessInteraction
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessInteraction[]} the converted nodes
	 */
	asBusinessInteractionArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessInteraction(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessInterface
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessInterface} the converted node or null if the input was not a string or object
	 */
	asBusinessInterface: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessInterface(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessInterface
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessInterface[]} the converted nodes
	 */
	asBusinessInterfaceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessInterface(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessObject
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessObject} the converted node or null if the input was not a string or object
	 */
	asBusinessObject: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessObject(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessObject
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessObject[]} the converted nodes
	 */
	asBusinessObjectArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessObject(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessProcess
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessProcess} the converted node or null if the input was not a string or object
	 */
	asBusinessProcess: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessProcess(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessProcess
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessProcess[]} the converted nodes
	 */
	asBusinessProcessArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessProcess(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessRole
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessRole} the converted node or null if the input was not a string or object
	 */
	asBusinessRole: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessRole(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessRole
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessRole[]} the converted nodes
	 */
	asBusinessRoleArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessRole(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_BusinessService
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_BusinessService} the converted node or null if the input was not a string or object
	 */
	asBusinessService: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_BusinessService(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_BusinessService
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_BusinessService[]} the converted nodes
	 */
	asBusinessServiceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_BusinessService(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Capability
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Capability} the converted node or null if the input was not a string or object
	 */
	asCapability: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Capability(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Capability
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Capability[]} the converted nodes
	 */
	asCapabilityArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Capability(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_CommunicationNetwork
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_CommunicationNetwork} the converted node or null if the input was not a string or object
	 */
	asCommunicationNetwork: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_CommunicationNetwork(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_CommunicationNetwork
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_CommunicationNetwork[]} the converted nodes
	 */
	asCommunicationNetworkArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_CommunicationNetwork(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Constraint
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Constraint} the converted node or null if the input was not a string or object
	 */
	asConstraint: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Constraint(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Constraint
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Constraint[]} the converted nodes
	 */
	asConstraintArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Constraint(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Contract
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Contract} the converted node or null if the input was not a string or object
	 */
	asContract: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Contract(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Contract
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Contract[]} the converted nodes
	 */
	asContractArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Contract(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_CourseOfAction
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_CourseOfAction} the converted node or null if the input was not a string or object
	 */
	asCourseOfAction: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_CourseOfAction(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_CourseOfAction
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_CourseOfAction[]} the converted nodes
	 */
	asCourseOfActionArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_CourseOfAction(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_DataObject
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_DataObject} the converted node or null if the input was not a string or object
	 */
	asDataObject: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_DataObject(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_DataObject
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_DataObject[]} the converted nodes
	 */
	asDataObjectArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_DataObject(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Deliverable
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Deliverable} the converted node or null if the input was not a string or object
	 */
	asDeliverable: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Deliverable(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Deliverable
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Deliverable[]} the converted nodes
	 */
	asDeliverableArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Deliverable(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Device
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Device} the converted node or null if the input was not a string or object
	 */
	asDevice: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Device(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Device
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Device[]} the converted nodes
	 */
	asDeviceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Device(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_DistributionNetwork
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_DistributionNetwork} the converted node or null if the input was not a string or object
	 */
	asDistributionNetwork: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_DistributionNetwork(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_DistributionNetwork
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_DistributionNetwork[]} the converted nodes
	 */
	asDistributionNetworkArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_DistributionNetwork(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Driver
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Driver} the converted node or null if the input was not a string or object
	 */
	asDriver: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Driver(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Driver
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Driver[]} the converted nodes
	 */
	asDriverArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Driver(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Equipment
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Equipment} the converted node or null if the input was not a string or object
	 */
	asEquipment: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Equipment(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Equipment
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Equipment[]} the converted nodes
	 */
	asEquipmentArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Equipment(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Facility
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Facility} the converted node or null if the input was not a string or object
	 */
	asFacility: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Facility(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Facility
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Facility[]} the converted nodes
	 */
	asFacilityArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Facility(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Gap
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Gap} the converted node or null if the input was not a string or object
	 */
	asGap: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Gap(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Gap
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Gap[]} the converted nodes
	 */
	asGapArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Gap(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Goal
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Goal} the converted node or null if the input was not a string or object
	 */
	asGoal: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Goal(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Goal
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Goal[]} the converted nodes
	 */
	asGoalArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Goal(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Grouping
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Grouping} the converted node or null if the input was not a string or object
	 */
	asGrouping: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Grouping(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Grouping
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Grouping[]} the converted nodes
	 */
	asGroupingArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Grouping(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_ImplementationEvent
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_ImplementationEvent} the converted node or null if the input was not a string or object
	 */
	asImplementationEvent: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_ImplementationEvent(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_ImplementationEvent
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_ImplementationEvent[]} the converted nodes
	 */
	asImplementationEventArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_ImplementationEvent(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Material
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Material} the converted node or null if the input was not a string or object
	 */
	asMaterial: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Material(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Material
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Material[]} the converted nodes
	 */
	asMaterialArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Material(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Meaning
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Meaning} the converted node or null if the input was not a string or object
	 */
	asMeaning: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Meaning(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Meaning
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Meaning[]} the converted nodes
	 */
	asMeaningArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Meaning(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Node
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Node} the converted node or null if the input was not a string or object
	 */
	asNode: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Node(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Node
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Node[]} the converted nodes
	 */
	asNodeArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Node(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Outcome
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Outcome} the converted node or null if the input was not a string or object
	 */
	asOutcome: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Outcome(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Outcome
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Outcome[]} the converted nodes
	 */
	asOutcomeArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Outcome(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Path
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Path} the converted node or null if the input was not a string or object
	 */
	asPath: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Path(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Path
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Path[]} the converted nodes
	 */
	asPathArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Path(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Plateau
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Plateau} the converted node or null if the input was not a string or object
	 */
	asPlateau: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Plateau(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Plateau
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Plateau[]} the converted nodes
	 */
	asPlateauArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Plateau(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Principle
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Principle} the converted node or null if the input was not a string or object
	 */
	asPrinciple: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Principle(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Principle
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Principle[]} the converted nodes
	 */
	asPrincipleArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Principle(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Product
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Product} the converted node or null if the input was not a string or object
	 */
	asProduct: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Product(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Product
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Product[]} the converted nodes
	 */
	asProductArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Product(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Representation
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Representation} the converted node or null if the input was not a string or object
	 */
	asRepresentation: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Representation(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Representation
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Representation[]} the converted nodes
	 */
	asRepresentationArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Representation(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Requirement
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Requirement} the converted node or null if the input was not a string or object
	 */
	asRequirement: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Requirement(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Requirement
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Requirement[]} the converted nodes
	 */
	asRequirementArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Requirement(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Resource
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Resource} the converted node or null if the input was not a string or object
	 */
	asResource: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Resource(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Resource
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Resource[]} the converted nodes
	 */
	asResourceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Resource(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Stakeholder
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Stakeholder} the converted node or null if the input was not a string or object
	 */
	asStakeholder: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Stakeholder(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Stakeholder
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Stakeholder[]} the converted nodes
	 */
	asStakeholderArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Stakeholder(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_SystemSoftware
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_SystemSoftware} the converted node or null if the input was not a string or object
	 */
	asSystemSoftware: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_SystemSoftware(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_SystemSoftware
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_SystemSoftware[]} the converted nodes
	 */
	asSystemSoftwareArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_SystemSoftware(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_TechnologyCollaboration
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_TechnologyCollaboration} the converted node or null if the input was not a string or object
	 */
	asTechnologyCollaboration: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_TechnologyCollaboration(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_TechnologyCollaboration
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_TechnologyCollaboration[]} the converted nodes
	 */
	asTechnologyCollaborationArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_TechnologyCollaboration(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_TechnologyEvent
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_TechnologyEvent} the converted node or null if the input was not a string or object
	 */
	asTechnologyEvent: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_TechnologyEvent(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_TechnologyEvent
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_TechnologyEvent[]} the converted nodes
	 */
	asTechnologyEventArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_TechnologyEvent(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_TechnologyFunction
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_TechnologyFunction} the converted node or null if the input was not a string or object
	 */
	asTechnologyFunction: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_TechnologyFunction(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_TechnologyFunction
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_TechnologyFunction[]} the converted nodes
	 */
	asTechnologyFunctionArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_TechnologyFunction(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_TechnologyInteraction
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_TechnologyInteraction} the converted node or null if the input was not a string or object
	 */
	asTechnologyInteraction: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_TechnologyInteraction(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_TechnologyInteraction
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_TechnologyInteraction[]} the converted nodes
	 */
	asTechnologyInteractionArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_TechnologyInteraction(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_TechnologyInterface
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_TechnologyInterface} the converted node or null if the input was not a string or object
	 */
	asTechnologyInterface: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_TechnologyInterface(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_TechnologyInterface
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_TechnologyInterface[]} the converted nodes
	 */
	asTechnologyInterfaceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_TechnologyInterface(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_TechnologyProcess
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_TechnologyProcess} the converted node or null if the input was not a string or object
	 */
	asTechnologyProcess: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_TechnologyProcess(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_TechnologyProcess
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_TechnologyProcess[]} the converted nodes
	 */
	asTechnologyProcessArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_TechnologyProcess(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_TechnologyService
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_TechnologyService} the converted node or null if the input was not a string or object
	 */
	asTechnologyService: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_TechnologyService(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_TechnologyService
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_TechnologyService[]} the converted nodes
	 */
	asTechnologyServiceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_TechnologyService(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_Value
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_Value} the converted node or null if the input was not a string or object
	 */
	asValue: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_Value(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_Value
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_Value[]} the converted nodes
	 */
	asValueArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_Value(obj));
	},
	
	/**
	 * Converts a value into an instance of archimate_WorkPackage
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?archimate_WorkPackage} the converted node or null if the input was not a string or object
	 */
	asWorkPackage: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new archimate_WorkPackage(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of archimate_WorkPackage
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {archimate_WorkPackage[]} the converted nodes
	 */
	asWorkPackageArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new archimate_WorkPackage(obj));
	},
	
	/**
	 * Creates a new instance of archimate_ApplicationCollaboration based on initial property values.
	 * @param {archimate_ApplicationCollaboration_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ApplicationCollaboration}
	 */
	createApplicationCollaboration: (props) => {
		return RDFNodeUtil.createInstance(archimate_ApplicationCollaboration, 'http://bp4mc2.org/def/archimate#ApplicationCollaboration', props);
	},
	
	/**
	 * Creates a new instance of archimate_ApplicationComponent based on initial property values.
	 * @param {archimate_ApplicationComponent_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ApplicationComponent}
	 */
	createApplicationComponent: (props) => {
		return RDFNodeUtil.createInstance(archimate_ApplicationComponent, 'http://bp4mc2.org/def/archimate#ApplicationComponent', props);
	},
	
	/**
	 * Creates a new instance of archimate_ApplicationEvent based on initial property values.
	 * @param {archimate_ApplicationEvent_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ApplicationEvent}
	 */
	createApplicationEvent: (props) => {
		return RDFNodeUtil.createInstance(archimate_ApplicationEvent, 'http://bp4mc2.org/def/archimate#ApplicationEvent', props);
	},
	
	/**
	 * Creates a new instance of archimate_ApplicationFunction based on initial property values.
	 * @param {archimate_ApplicationFunction_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ApplicationFunction}
	 */
	createApplicationFunction: (props) => {
		return RDFNodeUtil.createInstance(archimate_ApplicationFunction, 'http://bp4mc2.org/def/archimate#ApplicationFunction', props);
	},
	
	/**
	 * Creates a new instance of archimate_ApplicationInteraction based on initial property values.
	 * @param {archimate_ApplicationInteraction_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ApplicationInteraction}
	 */
	createApplicationInteraction: (props) => {
		return RDFNodeUtil.createInstance(archimate_ApplicationInteraction, 'http://bp4mc2.org/def/archimate#ApplicationInteraction', props);
	},
	
	/**
	 * Creates a new instance of archimate_ApplicationInterface based on initial property values.
	 * @param {archimate_ApplicationInterface_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ApplicationInterface}
	 */
	createApplicationInterface: (props) => {
		return RDFNodeUtil.createInstance(archimate_ApplicationInterface, 'http://bp4mc2.org/def/archimate#ApplicationInterface', props);
	},
	
	/**
	 * Creates a new instance of archimate_ApplicationProcess based on initial property values.
	 * @param {archimate_ApplicationProcess_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ApplicationProcess}
	 */
	createApplicationProcess: (props) => {
		return RDFNodeUtil.createInstance(archimate_ApplicationProcess, 'http://bp4mc2.org/def/archimate#ApplicationProcess', props);
	},
	
	/**
	 * Creates a new instance of archimate_ApplicationService based on initial property values.
	 * @param {archimate_ApplicationService_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ApplicationService}
	 */
	createApplicationService: (props) => {
		return RDFNodeUtil.createInstance(archimate_ApplicationService, 'http://bp4mc2.org/def/archimate#ApplicationService', props);
	},
	
	/**
	 * Creates a new instance of archimate_ArchimateModelElement based on initial property values.
	 * @param {archimate_ArchimateModelElement_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ArchimateModelElement}
	 */
	createArchimateModelElement: (props) => {
		return RDFNodeUtil.createInstance(archimate_ArchimateModelElement, 'http://bp4mc2.org/def/archimate#ArchimateModelElement', props);
	},
	
	/**
	 * Creates a new instance of archimate_Artifact based on initial property values.
	 * @param {archimate_Artifact_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Artifact}
	 */
	createArtifact: (props) => {
		return RDFNodeUtil.createInstance(archimate_Artifact, 'http://bp4mc2.org/def/archimate#Artifact', props);
	},
	
	/**
	 * Creates a new instance of archimate_Assessment based on initial property values.
	 * @param {archimate_Assessment_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Assessment}
	 */
	createAssessment: (props) => {
		return RDFNodeUtil.createInstance(archimate_Assessment, 'http://bp4mc2.org/def/archimate#Assessment', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessActor based on initial property values.
	 * @param {archimate_BusinessActor_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessActor}
	 */
	createBusinessActor: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessActor, 'http://bp4mc2.org/def/archimate#BusinessActor', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessCollaboration based on initial property values.
	 * @param {archimate_BusinessCollaboration_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessCollaboration}
	 */
	createBusinessCollaboration: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessCollaboration, 'http://bp4mc2.org/def/archimate#BusinessCollaboration', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessEvent based on initial property values.
	 * @param {archimate_BusinessEvent_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessEvent}
	 */
	createBusinessEvent: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessEvent, 'http://bp4mc2.org/def/archimate#BusinessEvent', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessFunction based on initial property values.
	 * @param {archimate_BusinessFunction_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessFunction}
	 */
	createBusinessFunction: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessFunction, 'http://bp4mc2.org/def/archimate#BusinessFunction', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessInteraction based on initial property values.
	 * @param {archimate_BusinessInteraction_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessInteraction}
	 */
	createBusinessInteraction: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessInteraction, 'http://bp4mc2.org/def/archimate#BusinessInteraction', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessInterface based on initial property values.
	 * @param {archimate_BusinessInterface_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessInterface}
	 */
	createBusinessInterface: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessInterface, 'http://bp4mc2.org/def/archimate#BusinessInterface', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessObject based on initial property values.
	 * @param {archimate_BusinessObject_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessObject}
	 */
	createBusinessObject: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessObject, 'http://bp4mc2.org/def/archimate#BusinessObject', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessProcess based on initial property values.
	 * @param {archimate_BusinessProcess_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessProcess}
	 */
	createBusinessProcess: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessProcess, 'http://bp4mc2.org/def/archimate#BusinessProcess', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessRole based on initial property values.
	 * @param {archimate_BusinessRole_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessRole}
	 */
	createBusinessRole: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessRole, 'http://bp4mc2.org/def/archimate#BusinessRole', props);
	},
	
	/**
	 * Creates a new instance of archimate_BusinessService based on initial property values.
	 * @param {archimate_BusinessService_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_BusinessService}
	 */
	createBusinessService: (props) => {
		return RDFNodeUtil.createInstance(archimate_BusinessService, 'http://bp4mc2.org/def/archimate#BusinessService', props);
	},
	
	/**
	 * Creates a new instance of archimate_Capability based on initial property values.
	 * @param {archimate_Capability_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Capability}
	 */
	createCapability: (props) => {
		return RDFNodeUtil.createInstance(archimate_Capability, 'http://bp4mc2.org/def/archimate#Capability', props);
	},
	
	/**
	 * Creates a new instance of archimate_CommunicationNetwork based on initial property values.
	 * @param {archimate_CommunicationNetwork_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_CommunicationNetwork}
	 */
	createCommunicationNetwork: (props) => {
		return RDFNodeUtil.createInstance(archimate_CommunicationNetwork, 'http://bp4mc2.org/def/archimate#CommunicationNetwork', props);
	},
	
	/**
	 * Creates a new instance of archimate_Constraint based on initial property values.
	 * @param {archimate_Constraint_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Constraint}
	 */
	createConstraint: (props) => {
		return RDFNodeUtil.createInstance(archimate_Constraint, 'http://bp4mc2.org/def/archimate#Constraint', props);
	},
	
	/**
	 * Creates a new instance of archimate_Contract based on initial property values.
	 * @param {archimate_Contract_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Contract}
	 */
	createContract: (props) => {
		return RDFNodeUtil.createInstance(archimate_Contract, 'http://bp4mc2.org/def/archimate#Contract', props);
	},
	
	/**
	 * Creates a new instance of archimate_CourseOfAction based on initial property values.
	 * @param {archimate_CourseOfAction_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_CourseOfAction}
	 */
	createCourseOfAction: (props) => {
		return RDFNodeUtil.createInstance(archimate_CourseOfAction, 'http://bp4mc2.org/def/archimate#CourseOfAction', props);
	},
	
	/**
	 * Creates a new instance of archimate_DataObject based on initial property values.
	 * @param {archimate_DataObject_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_DataObject}
	 */
	createDataObject: (props) => {
		return RDFNodeUtil.createInstance(archimate_DataObject, 'http://bp4mc2.org/def/archimate#DataObject', props);
	},
	
	/**
	 * Creates a new instance of archimate_Deliverable based on initial property values.
	 * @param {archimate_Deliverable_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Deliverable}
	 */
	createDeliverable: (props) => {
		return RDFNodeUtil.createInstance(archimate_Deliverable, 'http://bp4mc2.org/def/archimate#Deliverable', props);
	},
	
	/**
	 * Creates a new instance of archimate_Device based on initial property values.
	 * @param {archimate_Device_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Device}
	 */
	createDevice: (props) => {
		return RDFNodeUtil.createInstance(archimate_Device, 'http://bp4mc2.org/def/archimate#Device', props);
	},
	
	/**
	 * Creates a new instance of archimate_DistributionNetwork based on initial property values.
	 * @param {archimate_DistributionNetwork_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_DistributionNetwork}
	 */
	createDistributionNetwork: (props) => {
		return RDFNodeUtil.createInstance(archimate_DistributionNetwork, 'http://bp4mc2.org/def/archimate#DistributionNetwork', props);
	},
	
	/**
	 * Creates a new instance of archimate_Driver based on initial property values.
	 * @param {archimate_Driver_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Driver}
	 */
	createDriver: (props) => {
		return RDFNodeUtil.createInstance(archimate_Driver, 'http://bp4mc2.org/def/archimate#Driver', props);
	},
	
	/**
	 * Creates a new instance of archimate_Equipment based on initial property values.
	 * @param {archimate_Equipment_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Equipment}
	 */
	createEquipment: (props) => {
		return RDFNodeUtil.createInstance(archimate_Equipment, 'http://bp4mc2.org/def/archimate#Equipment', props);
	},
	
	/**
	 * Creates a new instance of archimate_Facility based on initial property values.
	 * @param {archimate_Facility_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Facility}
	 */
	createFacility: (props) => {
		return RDFNodeUtil.createInstance(archimate_Facility, 'http://bp4mc2.org/def/archimate#Facility', props);
	},
	
	/**
	 * Creates a new instance of archimate_Gap based on initial property values.
	 * @param {archimate_Gap_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Gap}
	 */
	createGap: (props) => {
		return RDFNodeUtil.createInstance(archimate_Gap, 'http://bp4mc2.org/def/archimate#Gap', props);
	},
	
	/**
	 * Creates a new instance of archimate_Goal based on initial property values.
	 * @param {archimate_Goal_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Goal}
	 */
	createGoal: (props) => {
		return RDFNodeUtil.createInstance(archimate_Goal, 'http://bp4mc2.org/def/archimate#Goal', props);
	},
	
	/**
	 * Creates a new instance of archimate_Grouping based on initial property values.
	 * @param {archimate_Grouping_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Grouping}
	 */
	createGrouping: (props) => {
		return RDFNodeUtil.createInstance(archimate_Grouping, 'http://bp4mc2.org/def/archimate#Grouping', props);
	},
	
	/**
	 * Creates a new instance of archimate_ImplementationEvent based on initial property values.
	 * @param {archimate_ImplementationEvent_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_ImplementationEvent}
	 */
	createImplementationEvent: (props) => {
		return RDFNodeUtil.createInstance(archimate_ImplementationEvent, 'http://bp4mc2.org/def/archimate#ImplementationEvent', props);
	},
	
	/**
	 * Creates a new instance of archimate_Material based on initial property values.
	 * @param {archimate_Material_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Material}
	 */
	createMaterial: (props) => {
		return RDFNodeUtil.createInstance(archimate_Material, 'http://bp4mc2.org/def/archimate#Material', props);
	},
	
	/**
	 * Creates a new instance of archimate_Meaning based on initial property values.
	 * @param {archimate_Meaning_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Meaning}
	 */
	createMeaning: (props) => {
		return RDFNodeUtil.createInstance(archimate_Meaning, 'http://bp4mc2.org/def/archimate#Meaning', props);
	},
	
	/**
	 * Creates a new instance of archimate_Node based on initial property values.
	 * @param {archimate_Node_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Node}
	 */
	createNode: (props) => {
		return RDFNodeUtil.createInstance(archimate_Node, 'http://bp4mc2.org/def/archimate#Node', props);
	},
	
	/**
	 * Creates a new instance of archimate_Outcome based on initial property values.
	 * @param {archimate_Outcome_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Outcome}
	 */
	createOutcome: (props) => {
		return RDFNodeUtil.createInstance(archimate_Outcome, 'http://bp4mc2.org/def/archimate#Outcome', props);
	},
	
	/**
	 * Creates a new instance of archimate_Path based on initial property values.
	 * @param {archimate_Path_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Path}
	 */
	createPath: (props) => {
		return RDFNodeUtil.createInstance(archimate_Path, 'http://bp4mc2.org/def/archimate#Path', props);
	},
	
	/**
	 * Creates a new instance of archimate_Plateau based on initial property values.
	 * @param {archimate_Plateau_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Plateau}
	 */
	createPlateau: (props) => {
		return RDFNodeUtil.createInstance(archimate_Plateau, 'http://bp4mc2.org/def/archimate#Plateau', props);
	},
	
	/**
	 * Creates a new instance of archimate_Principle based on initial property values.
	 * @param {archimate_Principle_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Principle}
	 */
	createPrinciple: (props) => {
		return RDFNodeUtil.createInstance(archimate_Principle, 'http://bp4mc2.org/def/archimate#Principle', props);
	},
	
	/**
	 * Creates a new instance of archimate_Product based on initial property values.
	 * @param {archimate_Product_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Product}
	 */
	createProduct: (props) => {
		return RDFNodeUtil.createInstance(archimate_Product, 'http://bp4mc2.org/def/archimate#Product', props);
	},
	
	/**
	 * Creates a new instance of archimate_Representation based on initial property values.
	 * @param {archimate_Representation_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Representation}
	 */
	createRepresentation: (props) => {
		return RDFNodeUtil.createInstance(archimate_Representation, 'http://bp4mc2.org/def/archimate#Representation', props);
	},
	
	/**
	 * Creates a new instance of archimate_Requirement based on initial property values.
	 * @param {archimate_Requirement_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Requirement}
	 */
	createRequirement: (props) => {
		return RDFNodeUtil.createInstance(archimate_Requirement, 'http://bp4mc2.org/def/archimate#Requirement', props);
	},
	
	/**
	 * Creates a new instance of archimate_Resource based on initial property values.
	 * @param {archimate_Resource_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Resource}
	 */
	createResource: (props) => {
		return RDFNodeUtil.createInstance(archimate_Resource, 'http://bp4mc2.org/def/archimate#Resource', props);
	},
	
	/**
	 * Creates a new instance of archimate_Stakeholder based on initial property values.
	 * @param {archimate_Stakeholder_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Stakeholder}
	 */
	createStakeholder: (props) => {
		return RDFNodeUtil.createInstance(archimate_Stakeholder, 'http://bp4mc2.org/def/archimate#Stakeholder', props);
	},
	
	/**
	 * Creates a new instance of archimate_SystemSoftware based on initial property values.
	 * @param {archimate_SystemSoftware_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_SystemSoftware}
	 */
	createSystemSoftware: (props) => {
		return RDFNodeUtil.createInstance(archimate_SystemSoftware, 'http://bp4mc2.org/def/archimate#SystemSoftware', props);
	},
	
	/**
	 * Creates a new instance of archimate_TechnologyCollaboration based on initial property values.
	 * @param {archimate_TechnologyCollaboration_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_TechnologyCollaboration}
	 */
	createTechnologyCollaboration: (props) => {
		return RDFNodeUtil.createInstance(archimate_TechnologyCollaboration, 'http://bp4mc2.org/def/archimate#TechnologyCollaboration', props);
	},
	
	/**
	 * Creates a new instance of archimate_TechnologyEvent based on initial property values.
	 * @param {archimate_TechnologyEvent_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_TechnologyEvent}
	 */
	createTechnologyEvent: (props) => {
		return RDFNodeUtil.createInstance(archimate_TechnologyEvent, 'http://bp4mc2.org/def/archimate#TechnologyEvent', props);
	},
	
	/**
	 * Creates a new instance of archimate_TechnologyFunction based on initial property values.
	 * @param {archimate_TechnologyFunction_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_TechnologyFunction}
	 */
	createTechnologyFunction: (props) => {
		return RDFNodeUtil.createInstance(archimate_TechnologyFunction, 'http://bp4mc2.org/def/archimate#TechnologyFunction', props);
	},
	
	/**
	 * Creates a new instance of archimate_TechnologyInteraction based on initial property values.
	 * @param {archimate_TechnologyInteraction_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_TechnologyInteraction}
	 */
	createTechnologyInteraction: (props) => {
		return RDFNodeUtil.createInstance(archimate_TechnologyInteraction, 'http://bp4mc2.org/def/archimate#TechnologyInteraction', props);
	},
	
	/**
	 * Creates a new instance of archimate_TechnologyInterface based on initial property values.
	 * @param {archimate_TechnologyInterface_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_TechnologyInterface}
	 */
	createTechnologyInterface: (props) => {
		return RDFNodeUtil.createInstance(archimate_TechnologyInterface, 'http://bp4mc2.org/def/archimate#TechnologyInterface', props);
	},
	
	/**
	 * Creates a new instance of archimate_TechnologyProcess based on initial property values.
	 * @param {archimate_TechnologyProcess_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_TechnologyProcess}
	 */
	createTechnologyProcess: (props) => {
		return RDFNodeUtil.createInstance(archimate_TechnologyProcess, 'http://bp4mc2.org/def/archimate#TechnologyProcess', props);
	},
	
	/**
	 * Creates a new instance of archimate_TechnologyService based on initial property values.
	 * @param {archimate_TechnologyService_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_TechnologyService}
	 */
	createTechnologyService: (props) => {
		return RDFNodeUtil.createInstance(archimate_TechnologyService, 'http://bp4mc2.org/def/archimate#TechnologyService', props);
	},
	
	/**
	 * Creates a new instance of archimate_Value based on initial property values.
	 * @param {archimate_Value_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_Value}
	 */
	createValue: (props) => {
		return RDFNodeUtil.createInstance(archimate_Value, 'http://bp4mc2.org/def/archimate#Value', props);
	},
	
	/**
	 * Creates a new instance of archimate_WorkPackage based on initial property values.
	 * @param {archimate_WorkPackage_Props} props - name-value pairs for the initial properties
	 * @returns {archimate_WorkPackage}
	 */
	createWorkPackage: (props) => {
		return RDFNodeUtil.createInstance(archimate_WorkPackage, 'http://bp4mc2.org/def/archimate#WorkPackage', props);
	},
	
	/**
	 * Gets all instances of the class archimate:ApplicationCollaboration in the data graph.
	 * @returns {archimate_ApplicationCollaboration[]} all instances including those of subclasses
	 */
	everyApplicationCollaboration: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ApplicationCollaboration"), archimate_ApplicationCollaboration);
	},
	
	/**
	 * Gets all instances of the class archimate:ApplicationComponent in the data graph.
	 * @returns {archimate_ApplicationComponent[]} all instances including those of subclasses
	 */
	everyApplicationComponent: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ApplicationComponent"), archimate_ApplicationComponent);
	},
	
	/**
	 * Gets all instances of the class archimate:ApplicationEvent in the data graph.
	 * @returns {archimate_ApplicationEvent[]} all instances including those of subclasses
	 */
	everyApplicationEvent: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ApplicationEvent"), archimate_ApplicationEvent);
	},
	
	/**
	 * Gets all instances of the class archimate:ApplicationFunction in the data graph.
	 * @returns {archimate_ApplicationFunction[]} all instances including those of subclasses
	 */
	everyApplicationFunction: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ApplicationFunction"), archimate_ApplicationFunction);
	},
	
	/**
	 * Gets all instances of the class archimate:ApplicationInteraction in the data graph.
	 * @returns {archimate_ApplicationInteraction[]} all instances including those of subclasses
	 */
	everyApplicationInteraction: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ApplicationInteraction"), archimate_ApplicationInteraction);
	},
	
	/**
	 * Gets all instances of the class archimate:ApplicationInterface in the data graph.
	 * @returns {archimate_ApplicationInterface[]} all instances including those of subclasses
	 */
	everyApplicationInterface: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ApplicationInterface"), archimate_ApplicationInterface);
	},
	
	/**
	 * Gets all instances of the class archimate:ApplicationProcess in the data graph.
	 * @returns {archimate_ApplicationProcess[]} all instances including those of subclasses
	 */
	everyApplicationProcess: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ApplicationProcess"), archimate_ApplicationProcess);
	},
	
	/**
	 * Gets all instances of the class archimate:ApplicationService in the data graph.
	 * @returns {archimate_ApplicationService[]} all instances including those of subclasses
	 */
	everyApplicationService: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ApplicationService"), archimate_ApplicationService);
	},
	
	/**
	 * Gets all instances of the class archimate:ArchimateModelElement in the data graph.
	 * @returns {archimate_ArchimateModelElement[]} all instances including those of subclasses
	 */
	everyArchimateModelElement: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ArchimateModelElement"), archimate_ArchimateModelElement);
	},
	
	/**
	 * Gets all instances of the class archimate:Artifact in the data graph.
	 * @returns {archimate_Artifact[]} all instances including those of subclasses
	 */
	everyArtifact: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Artifact"), archimate_Artifact);
	},
	
	/**
	 * Gets all instances of the class archimate:Assessment in the data graph.
	 * @returns {archimate_Assessment[]} all instances including those of subclasses
	 */
	everyAssessment: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Assessment"), archimate_Assessment);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessActor in the data graph.
	 * @returns {archimate_BusinessActor[]} all instances including those of subclasses
	 */
	everyBusinessActor: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessActor"), archimate_BusinessActor);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessCollaboration in the data graph.
	 * @returns {archimate_BusinessCollaboration[]} all instances including those of subclasses
	 */
	everyBusinessCollaboration: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessCollaboration"), archimate_BusinessCollaboration);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessEvent in the data graph.
	 * @returns {archimate_BusinessEvent[]} all instances including those of subclasses
	 */
	everyBusinessEvent: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessEvent"), archimate_BusinessEvent);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessFunction in the data graph.
	 * @returns {archimate_BusinessFunction[]} all instances including those of subclasses
	 */
	everyBusinessFunction: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessFunction"), archimate_BusinessFunction);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessInteraction in the data graph.
	 * @returns {archimate_BusinessInteraction[]} all instances including those of subclasses
	 */
	everyBusinessInteraction: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessInteraction"), archimate_BusinessInteraction);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessInterface in the data graph.
	 * @returns {archimate_BusinessInterface[]} all instances including those of subclasses
	 */
	everyBusinessInterface: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessInterface"), archimate_BusinessInterface);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessObject in the data graph.
	 * @returns {archimate_BusinessObject[]} all instances including those of subclasses
	 */
	everyBusinessObject: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessObject"), archimate_BusinessObject);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessProcess in the data graph.
	 * @returns {archimate_BusinessProcess[]} all instances including those of subclasses
	 */
	everyBusinessProcess: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessProcess"), archimate_BusinessProcess);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessRole in the data graph.
	 * @returns {archimate_BusinessRole[]} all instances including those of subclasses
	 */
	everyBusinessRole: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessRole"), archimate_BusinessRole);
	},
	
	/**
	 * Gets all instances of the class archimate:BusinessService in the data graph.
	 * @returns {archimate_BusinessService[]} all instances including those of subclasses
	 */
	everyBusinessService: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#BusinessService"), archimate_BusinessService);
	},
	
	/**
	 * Gets all instances of the class archimate:Capability in the data graph.
	 * @returns {archimate_Capability[]} all instances including those of subclasses
	 */
	everyCapability: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Capability"), archimate_Capability);
	},
	
	/**
	 * Gets all instances of the class archimate:CommunicationNetwork in the data graph.
	 * @returns {archimate_CommunicationNetwork[]} all instances including those of subclasses
	 */
	everyCommunicationNetwork: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#CommunicationNetwork"), archimate_CommunicationNetwork);
	},
	
	/**
	 * Gets all instances of the class archimate:Constraint in the data graph.
	 * @returns {archimate_Constraint[]} all instances including those of subclasses
	 */
	everyConstraint: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Constraint"), archimate_Constraint);
	},
	
	/**
	 * Gets all instances of the class archimate:Contract in the data graph.
	 * @returns {archimate_Contract[]} all instances including those of subclasses
	 */
	everyContract: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Contract"), archimate_Contract);
	},
	
	/**
	 * Gets all instances of the class archimate:CourseOfAction in the data graph.
	 * @returns {archimate_CourseOfAction[]} all instances including those of subclasses
	 */
	everyCourseOfAction: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#CourseOfAction"), archimate_CourseOfAction);
	},
	
	/**
	 * Gets all instances of the class archimate:DataObject in the data graph.
	 * @returns {archimate_DataObject[]} all instances including those of subclasses
	 */
	everyDataObject: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#DataObject"), archimate_DataObject);
	},
	
	/**
	 * Gets all instances of the class archimate:Deliverable in the data graph.
	 * @returns {archimate_Deliverable[]} all instances including those of subclasses
	 */
	everyDeliverable: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Deliverable"), archimate_Deliverable);
	},
	
	/**
	 * Gets all instances of the class archimate:Device in the data graph.
	 * @returns {archimate_Device[]} all instances including those of subclasses
	 */
	everyDevice: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Device"), archimate_Device);
	},
	
	/**
	 * Gets all instances of the class archimate:DistributionNetwork in the data graph.
	 * @returns {archimate_DistributionNetwork[]} all instances including those of subclasses
	 */
	everyDistributionNetwork: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#DistributionNetwork"), archimate_DistributionNetwork);
	},
	
	/**
	 * Gets all instances of the class archimate:Driver in the data graph.
	 * @returns {archimate_Driver[]} all instances including those of subclasses
	 */
	everyDriver: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Driver"), archimate_Driver);
	},
	
	/**
	 * Gets all instances of the class archimate:Equipment in the data graph.
	 * @returns {archimate_Equipment[]} all instances including those of subclasses
	 */
	everyEquipment: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Equipment"), archimate_Equipment);
	},
	
	/**
	 * Gets all instances of the class archimate:Facility in the data graph.
	 * @returns {archimate_Facility[]} all instances including those of subclasses
	 */
	everyFacility: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Facility"), archimate_Facility);
	},
	
	/**
	 * Gets all instances of the class archimate:Gap in the data graph.
	 * @returns {archimate_Gap[]} all instances including those of subclasses
	 */
	everyGap: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Gap"), archimate_Gap);
	},
	
	/**
	 * Gets all instances of the class archimate:Goal in the data graph.
	 * @returns {archimate_Goal[]} all instances including those of subclasses
	 */
	everyGoal: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Goal"), archimate_Goal);
	},
	
	/**
	 * Gets all instances of the class archimate:Grouping in the data graph.
	 * @returns {archimate_Grouping[]} all instances including those of subclasses
	 */
	everyGrouping: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Grouping"), archimate_Grouping);
	},
	
	/**
	 * Gets all instances of the class archimate:ImplementationEvent in the data graph.
	 * @returns {archimate_ImplementationEvent[]} all instances including those of subclasses
	 */
	everyImplementationEvent: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#ImplementationEvent"), archimate_ImplementationEvent);
	},
	
	/**
	 * Gets all instances of the class archimate:Material in the data graph.
	 * @returns {archimate_Material[]} all instances including those of subclasses
	 */
	everyMaterial: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Material"), archimate_Material);
	},
	
	/**
	 * Gets all instances of the class archimate:Meaning in the data graph.
	 * @returns {archimate_Meaning[]} all instances including those of subclasses
	 */
	everyMeaning: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Meaning"), archimate_Meaning);
	},
	
	/**
	 * Gets all instances of the class archimate:Node in the data graph.
	 * @returns {archimate_Node[]} all instances including those of subclasses
	 */
	everyNode: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Node"), archimate_Node);
	},
	
	/**
	 * Gets all instances of the class archimate:Outcome in the data graph.
	 * @returns {archimate_Outcome[]} all instances including those of subclasses
	 */
	everyOutcome: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Outcome"), archimate_Outcome);
	},
	
	/**
	 * Gets all instances of the class archimate:Path in the data graph.
	 * @returns {archimate_Path[]} all instances including those of subclasses
	 */
	everyPath: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Path"), archimate_Path);
	},
	
	/**
	 * Gets all instances of the class archimate:Plateau in the data graph.
	 * @returns {archimate_Plateau[]} all instances including those of subclasses
	 */
	everyPlateau: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Plateau"), archimate_Plateau);
	},
	
	/**
	 * Gets all instances of the class archimate:Principle in the data graph.
	 * @returns {archimate_Principle[]} all instances including those of subclasses
	 */
	everyPrinciple: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Principle"), archimate_Principle);
	},
	
	/**
	 * Gets all instances of the class archimate:Product in the data graph.
	 * @returns {archimate_Product[]} all instances including those of subclasses
	 */
	everyProduct: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Product"), archimate_Product);
	},
	
	/**
	 * Gets all instances of the class archimate:Representation in the data graph.
	 * @returns {archimate_Representation[]} all instances including those of subclasses
	 */
	everyRepresentation: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Representation"), archimate_Representation);
	},
	
	/**
	 * Gets all instances of the class archimate:Requirement in the data graph.
	 * @returns {archimate_Requirement[]} all instances including those of subclasses
	 */
	everyRequirement: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Requirement"), archimate_Requirement);
	},
	
	/**
	 * Gets all instances of the class archimate:Resource in the data graph.
	 * @returns {archimate_Resource[]} all instances including those of subclasses
	 */
	everyResource: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Resource"), archimate_Resource);
	},
	
	/**
	 * Gets all instances of the class archimate:Stakeholder in the data graph.
	 * @returns {archimate_Stakeholder[]} all instances including those of subclasses
	 */
	everyStakeholder: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Stakeholder"), archimate_Stakeholder);
	},
	
	/**
	 * Gets all instances of the class archimate:SystemSoftware in the data graph.
	 * @returns {archimate_SystemSoftware[]} all instances including those of subclasses
	 */
	everySystemSoftware: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#SystemSoftware"), archimate_SystemSoftware);
	},
	
	/**
	 * Gets all instances of the class archimate:TechnologyCollaboration in the data graph.
	 * @returns {archimate_TechnologyCollaboration[]} all instances including those of subclasses
	 */
	everyTechnologyCollaboration: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#TechnologyCollaboration"), archimate_TechnologyCollaboration);
	},
	
	/**
	 * Gets all instances of the class archimate:TechnologyEvent in the data graph.
	 * @returns {archimate_TechnologyEvent[]} all instances including those of subclasses
	 */
	everyTechnologyEvent: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#TechnologyEvent"), archimate_TechnologyEvent);
	},
	
	/**
	 * Gets all instances of the class archimate:TechnologyFunction in the data graph.
	 * @returns {archimate_TechnologyFunction[]} all instances including those of subclasses
	 */
	everyTechnologyFunction: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#TechnologyFunction"), archimate_TechnologyFunction);
	},
	
	/**
	 * Gets all instances of the class archimate:TechnologyInteraction in the data graph.
	 * @returns {archimate_TechnologyInteraction[]} all instances including those of subclasses
	 */
	everyTechnologyInteraction: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#TechnologyInteraction"), archimate_TechnologyInteraction);
	},
	
	/**
	 * Gets all instances of the class archimate:TechnologyInterface in the data graph.
	 * @returns {archimate_TechnologyInterface[]} all instances including those of subclasses
	 */
	everyTechnologyInterface: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#TechnologyInterface"), archimate_TechnologyInterface);
	},
	
	/**
	 * Gets all instances of the class archimate:TechnologyProcess in the data graph.
	 * @returns {archimate_TechnologyProcess[]} all instances including those of subclasses
	 */
	everyTechnologyProcess: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#TechnologyProcess"), archimate_TechnologyProcess);
	},
	
	/**
	 * Gets all instances of the class archimate:TechnologyService in the data graph.
	 * @returns {archimate_TechnologyService[]} all instances including those of subclasses
	 */
	everyTechnologyService: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#TechnologyService"), archimate_TechnologyService);
	},
	
	/**
	 * Gets all instances of the class archimate:Value in the data graph.
	 * @returns {archimate_Value[]} all instances including those of subclasses
	 */
	everyValue: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#Value"), archimate_Value);
	},
	
	/**
	 * Gets all instances of the class archimate:WorkPackage in the data graph.
	 * @returns {archimate_WorkPackage[]} all instances including those of subclasses
	 */
	everyWorkPackage: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://bp4mc2.org/def/archimate#WorkPackage"), archimate_WorkPackage);
	},
	
	
	NS: "http://bp4mc2.org/def/archimate#",
	PREFIX: "archimate",
}
...
const dash = {
	 ...
	 * @param {rdfs_Resource} subject  The subject to get the number of objects of.
	 * @param {rdfs_Resource} predicate  The predicate to get the number of objects of.
	 * @returns {number}
	 */
...
/**
 * Generated from the namespace <http://xmlns.com/foaf/0.1/>
 */
const foaf = {
...
/**
 * Generated from the namespace <http://www.w3.org/2003/01/geo/wgs84_pos#>
 */
const geo = {
...
/**
 * Generated from the namespace <http://teamwork.topbraidlive.org/ontologyprojects#>
 */
const ontologyprojects = {

	/**
	 * Gets all instances of the class ontologyprojects:Ontology in the data graph.
	 * @returns {NamedNode[]} all instances including those of subclasses
	 */
	everyOntology: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://teamwork.topbraidlive.org/ontologyprojects#Ontology"), NamedNode);
	},
	
	
	NS: "http://teamwork.topbraidlive.org/ontologyprojects#",
...
const owl = {
	...
	/**
	 * Converts a value into an instance of owl_Thing
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?owl_Thing} the converted node or null if the input was not a string or object
	 */
	asThing: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new owl_Thing(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of owl_Thing
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {owl_Thing[]} the converted nodes
	 */
	asThingArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new owl_Thing(obj));
	},
	...
	/**
	 * Creates a new instance of owl_Thing based on initial property values.
	 * @param {owl_Thing_Props} props - name-value pairs for the initial properties
	 * @returns {owl_Thing}
	 */
	createThing: (props) => {
		return RDFNodeUtil.createInstance(owl_Thing, 'http://www.w3.org/2002/07/owl#Thing', props);
	},
	...
	/**
	 * Gets all instances of the class owl:Thing in the data graph.
	 * @returns {owl_Thing[]} all instances including those of subclasses
	 */
	everyThing: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://www.w3.org/2002/07/owl#Thing"), owl_Thing);
	},
...
const rdfs = {
	...
	/**
	 * Converts a value into an instance of rdfs_Resource
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?rdfs_Resource} the converted node or null if the input was not a string or object
	 */
	asResource: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new rdfs_Resource(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of rdfs_Resource
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {rdfs_Resource[]} the converted nodes
	 */
	asResourceArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new rdfs_Resource(obj));
	},
	...
	/**
	 * Creates a new instance of rdfs_Resource based on initial property values.
	 * @param {rdfs_Resource_Props} props - name-value pairs for the initial properties
	 * @returns {rdfs_Resource}
	 */
	createResource: (props) => {
		return RDFNodeUtil.createInstance(rdfs_Resource, 'http://www.w3.org/2000/01/rdf-schema#Resource', props);
	},
	 ...
	 * @returns {rdfs_Resource[]} all instances including those of subclasses
	 */
	everyResource: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://www.w3.org/2000/01/rdf-schema#Resource"), rdfs_Resource);
	},
...
/**
 * Generated from the namespace <http://rdm.topbraidlive.org/rdmprojects#>
 */
const rdmprojects = {

	/**
	 * Gets all instances of the class rdmprojects:ReferenceDataset in the data graph.
	 * @returns {NamedNode[]} all instances including those of subclasses
	 */
	everyReferenceDataset: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://rdm.topbraidlive.org/rdmprojects#ReferenceDataset"), NamedNode);
	},
	
	
	NS: "http://rdm.topbraidlive.org/rdmprojects#",
	PREFIX: "rdmprojects",
}
...
/**
 * Generated from the namespace <http://purl.org/iso25964/skos-thes#>
 */
const skosthes = {

	/**
	 * Converts a value into an instance of skosthes_ConceptGroup
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?skosthes_ConceptGroup} the converted node or null if the input was not a string or object
	 */
	asConceptGroup: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new skosthes_ConceptGroup(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of skosthes_ConceptGroup
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {skosthes_ConceptGroup[]} the converted nodes
	 */
	asConceptGroupArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new skosthes_ConceptGroup(obj));
	},
	
	/**
	 * Converts a value into an instance of skosthes_ThesaurusArray
	 * @param {?GraphNode|?string|?boolean|?number} obj - the node or URI string to convert
	 * @returns {?skosthes_ThesaurusArray} the converted node or null if the input was not a string or object
	 */
	asThesaurusArray: (obj) => {
		return obj == null || typeof obj == 'boolean' || typeof obj == 'number' ? null : new skosthes_ThesaurusArray(obj);
	},
	
	/**
	 * Converts an array of values into an array of instances of skosthes_ThesaurusArray
	 * @param {(GraphNode|string|boolean|number)[]} objs - the nodes or URI strings to convert
	 * @returns {skosthes_ThesaurusArray[]} the converted nodes
	 */
	asThesaurusArrayArray: (objs) => {
		return objs.filter(obj => typeof obj != 'boolean' && typeof obj != 'number').map(obj => new skosthes_ThesaurusArray(obj));
	},
	
	/**
	 * Creates a new instance of skosthes_ConceptGroup based on initial property values.
	 * @param {skosthes_ConceptGroup_Props} props - name-value pairs for the initial properties
	 * @returns {skosthes_ConceptGroup}
	 */
	createConceptGroup: (props) => {
		return RDFNodeUtil.createInstance(skosthes_ConceptGroup, 'http://purl.org/iso25964/skos-thes#ConceptGroup', props);
	},
	
	/**
	 * Creates a new instance of skosthes_ThesaurusArray based on initial property values.
	 * @param {skosthes_ThesaurusArray_Props} props - name-value pairs for the initial properties
	 * @returns {skosthes_ThesaurusArray}
	 */
	createThesaurusArray: (props) => {
		return RDFNodeUtil.createInstance(skosthes_ThesaurusArray, 'http://purl.org/iso25964/skos-thes#ThesaurusArray', props);
	},
	
	/**
	 * Gets all instances of the class skosthes:ConceptGroup in the data graph.
	 * @returns {skosthes_ConceptGroup[]} all instances including those of subclasses
	 */
	everyConceptGroup: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://purl.org/iso25964/skos-thes#ConceptGroup"), skosthes_ConceptGroup);
	},
	
	/**
	 * Gets all instances of the class skosthes:ThesaurusArray in the data graph.
	 * @returns {skosthes_ThesaurusArray[]} all instances including those of subclasses
	 */
	everyThesaurusArray: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://purl.org/iso25964/skos-thes#ThesaurusArray"), skosthes_ThesaurusArray);
	},
...
const smf = {
	 ...
	 */
	baseURI(arg1) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/sparqlmotionfunctions#baseURI", arg1), rdfs_Resource);
	},
	
	/**
	 * Checks if a given graph can be read (by the current user).
	 * @param {rdfs_Resource} arg1  Graph base URI
	 * @returns {boolean}
	 */
	canRead(arg1) {
	 ...
	 * @param {rdfs_Resource} arg1  The base URI of the graph represented by the file of which to get the time stamp.
	 * @returns {number}
	 */
	 ...
	 * @param {rdfs_Resource} arg1  The graph URI.
	 * @returns {boolean}
	 */
	isSystemGraph(arg1) {
	 ...
	 * @param {rdfs_Resource} arg1  The resource to find the reference to.
	 * @returns {rdfs_Resource}
	 */
	rootURISubject(arg1) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/sparqlmotionfunctions#rootURISubject", arg1), rdfs_Resource);
	},
	 ...
	 * @param {rdfs_Resource} arg1  The subject of the triple.
	 * @param {rdf_Property} arg2  The predicate of the triple.
	 * @param arg3  The object of the triple.
	 * @returns {rdfs_Resource}
	 */
	tripleDefinedIn(arg1, arg2, arg3) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/sparqlmotionfunctions#tripleDefinedIn", arg1, arg2, arg3), rdfs_Resource);
	},
	 ...
	 * @param {rdfs_Resource} user  The URI node of the user.
	 * @returns {string}
	 */
	 ...
	 * @param {rdfs_Resource} arg1  The user resource to convert to a name.
	 * @returns {rdfs_Resource}
	 */
	userName(arg1) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/sparqlmotionfunctions#userName", arg1), rdfs_Resource);
	},
	 ...
	 */
	userWithName(arg1) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/sparqlmotionfunctions#userWithName", arg1), rdfs_Resource);
	},
...
const spif = {
	 ...
	 * @param {rdfs_Resource} arg1  The resource to generate a label for.
	 * @returns {string}
	 */
	generateLabel(arg1) {
...
/**
 * Generated from the namespace <http://evn.topbraidlive.org/evnprojects#>
 */
const taxonomies = {

	/**
	 * Gets all instances of the class taxonomies:Taxonomy in the data graph.
	 * @returns {NamedNode[]} all instances including those of subclasses
	 */
	everytaxonomies: () => {
		return RDFNodeUtil.castValues(__jenaData.every("http://evn.topbraidlive.org/evnprojects#Taxonomy"), NamedNode);
	},
	
	
	NS: "http://evn.topbraidlive.org/evnprojects#",
	PREFIX: "taxonomies",
}
...
const tbs = {
	...
	assetCollectionTypeWithLabel(label) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tbs#assetCollectionTypeWithLabel", label), rdfs_Resource);
	},
	...
	assetCollectionURI(id) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tbs#assetCollectionURI", id), rdfs_Resource);
	},
	...
	queryGraph(workflowId) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tbs#queryGraph", workflowId), rdfs_Resource);
	},
	 ...
	 */
	userURI(userId) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tbs#userURI", userId), rdfs_Resource);
	},
	 ...
	 */
	workflowStatus(id) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tbs#workflowStatus", id), rdfs_Resource);
	},
	 ...
	 */
	workflowURI(id) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tbs#workflowURI", id), rdfs_Resource);
	},
	 ...
	 * @property {rdfs_Resource} instance The matching instances.
	 ...
	 * @param {rdfs_Resource} type  The class that all matching instances must have as type (or subclass thereof).
	...
	autoComplete(type, start, langs, maxCount, offset, filterFunction, filterFunctionArg2, filterFunctionArg3, filterFunctionArg4) {
		...
		return rs.bindings.map(b => ({instance: RDFNodeUtil.castValue(b['instance'], rdfs_Resource), label: RDFNodeUtil.castValue(b['label'], null), realLabel: RDFNodeUtil.castValue(b['realLabel'], null)}))
	},
	 ...
	 * @param {rdfs_Resource} change  The URI resource of the change, typically produced by a prior call to tbs:changes.
	 ...
	 * @property {rdfs_Resource} change The RDF resources representing the matching changes in the TCH graph.
	 ...
	 * @param {rdfs_Resource} about  An optional RDF node that must be mentioned in the changes that shall be returned.
	 ...
	 * @param {rdfs_Resource} predicate  An optional URI of a property that is the predicate of the added or deleted triples of matching changes.
	 ...
	 * @returns {rdfs_Resource[]}  The new status(es) that can be reached from the current status.
	 */
	possibleNextWorkflowStatuses() {
		...
		let rs = graph.select(query, {});
		return rs.bindings.map(b => RDFNodeUtil.castValue(b['newStatus'], rdfs_Resource));
	},
	
	/**
	 * @typedef {Object} tbs_remoteMatches_Results
	 * @property {rdfs_Resource} local The resulting local match (one of the given resources).
	 * @property {rdfs_Resource} remote The resulting remote match.
	 */
	...
	remoteMatches(propertyShape, resources) {
		...
		return rs.bindings.map(b => ({local: RDFNodeUtil.castValue(b['local'], rdfs_Resource), remote: RDFNodeUtil.castValue(b['remote'], rdfs_Resource)}))
	},
	 ...
	 * @property {rdfs_Resource} constraintComponent The constraint component of the validation result, derived from sh:sourceConstraintComponent.
	...
	validate(targetNode, shapesGraph) {
		...
		return rs.bindings.map(b => ({focusNode: RDFNodeUtil.castValue(b['focusNode'], null), pathExpression: RDFNodeUtil.castValue(b['pathExpression'], null), value: RDFNodeUtil.castValue(b['value'], null), constraintComponent: RDFNodeUtil.castValue(b['constraintComponent'], rdfs_Resource), severity: RDFNodeUtil.castValue(b['severity'], null), message: RDFNodeUtil.castValue(b['message'], null)}))
	},
	 ...
	 * This function can not be called when the active graph is a working copy of an asset collection.
	 * @param {rdfs_Resource} party  The user or organization to add. For users this must be a URI in the format returned by tbs:userURI().
	 ...
	 * @property {rdfs_Resource?} editedAsset The RDF resource that is the main edited asset in this workflow.
	 ...
	 * @param {rdfs_Resource} resource  A URI resource that the references to shall be loaded.
	 * @returns {boolean}
	 */
	 ...
	 * 
	 * This operation is allowed for administrators or managers of the asset collection or the workflow only.
	 * @param {rdfs_Resource} party  The user or organization to remove. For users this must be a URI in the format returned by tbs:userURI().
	 * @param {string} permission  Either 'viewer', 'editor' or 'manager'.
	 ...
	 * This function can not be called when the active graph is the master graph of an asset collection.
	 * @param {rdfs_Resource} status  The new status of the workflow. Example values are 'http://topbraid.org/teamwork#Committed' or 'http://topbraid.org/teamwork#Uncommitted'.
	 * @returns {boolean}
	 */
...
const teamwork = {
	 ...
	 */
	authGraph() {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#authGraph"), rdfs_Resource);
	},
	 ...
	 */
	currentMasterGraph() {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#currentMasterGraph"), rdfs_Resource);
	},
	 ...
	 */
	currentTeamGraph() {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#currentTeamGraph"), rdfs_Resource);
	},
	 ...
	 * @param {rdfs_Resource} projectGraph  The vocabulary to potentially create a working copy for.
	 * @returns {boolean}
	 */
	 ...
	 * WARNING: This function is marked experimental, so use at your own risk.
	 * @param {rdfs_Resource} resource  The resource to (potentially) transition.
	 * @param {rdfs_Resource} teamGraph  The current TCH graph.
	 ...
	 * @param {rdfs_Resource} projectGraph  The project graph.
	 * @returns {boolean}
	 */
	 ...
	 * @param {rdfs_Resource} projectGraph  The master graph to open.
	 * @param {rdfs_Resource?} resource  The resource to deep link to.
	 ...
	 * @param {rdfs_Resource} projectGraph  The asset collection graph.
	 * @returns {NamedNode}
	 */
	 ...
	 * @param {rdfs_Resource?} projectGraph  The master graph.
	 * @param {NamedNode?} tag  The working copy.
	 * @returns {rdfs_Resource}
	 */
	getQueryGraph(projectGraph, tag) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#getQueryGraph", projectGraph, tag), rdfs_Resource);
	},
	 ...
	 * @param {rdfs_Resource} arg1  The base URI (resource) of the main file to check.
	 * @returns {boolean}
	 */
	hasTeamGraph(arg1) {
	 ...
	 * @param {rdfs_Resource} projectGraph  The master graph to check.
	 * @returns {boolean}
	 */
	 ...
	 * @param {rdfs_Resource} resource  The resource to check.
	 * @returns {boolean}
	 */
	 ...
	 * @param {rdfs_Resource} teamGraph  The TCH graph (may be a ui:graphWithImports).
	 * @returns {rdfs_Resource}
	 */
	masterGraphForTeamGraph(teamGraph) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#masterGraphForTeamGraph", teamGraph), rdfs_Resource);
	},
	...
	platformGovernanceGraph() {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#platformGovernanceGraph"), rdfs_Resource);
	},
	 ...
	 * @param {rdfs_Resource} projectGraph  The project graph (URI resource).
	 * @returns {string}
	 */
	 ...
	 * ...
	 * @param {rdfs_Resource} arg1  The base URI (resource) of the main file to get the team graph URI of.
	 * @returns {rdfs_Resource}
	 */
	teamGraph(arg1) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#teamGraph", arg1), rdfs_Resource);
	},
	...
	unionGraphForCurrentUser() {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#unionGraphForCurrentUser"), rdfs_Resource);
	},
	 ...
	 * @param {rdfs_Resource} user  The user resource.
	 * @returns {boolean}
	 */
	 ...
	 */
	usersGraph() {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#usersGraph"), rdfs_Resource);
	},
	 ...
	 * WARNING: This function is marked experimental, so use at your own risk.
	 * @param {rdfs_Resource} focusNode  The subject.
	 * @param {rdf_Property} predicate  The predicate.
	 * @param {rdfs_Resource} teamworkMasterGraph  The master graph, such as <urn:x-evn-master:geo> - this is needed to efficiently cache the values rules.
	 */
	...
	workflowCustomizationsGraph() {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#workflowCustomizationsGraph"), rdfs_Resource);
	},
	 ...
	 */
	workflowsGraph() {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/teamwork#workflowsGraph"), rdfs_Resource);
	},
	 ...
	 * @param {rdfs_Resource} editedAsset  The RDF resource that is the main edited asset in this workflow.
	 * @returns {string}
	 */
	 ...
	 * @param {rdfs_Resource} source
	 * @param {rdfs_Resource} target
	 * @returns {Object}
	 */
...
/**
 * Generated from the namespace <http://topbraid.org/teamworkconstraints#>
 */
const teamworkconstraints = {

	
	NS: "http://topbraid.org/teamworkconstraints#",
...
const tosh = {
	...
	reificationPredicate(uri) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tosh#reificationPredicate", uri), rdfs_Resource);
	},
	...
	reificationSubject(uri) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tosh#reificationSubject", uri), rdfs_Resource);
	},
	...
	reificationURI(subject, predicate, object) {
		return RDFNodeUtil.castValue(__jenaData.callFunction("http://topbraid.org/tosh#reificationURI", subject, predicate, object), rdfs_Resource);
	},
	 ...
	 * @param {rdfs_Resource} shapesGraph  The URI of the shapes graph.
...
/**
 * Generated from the shape http://www.w3.org/2000/01/rdf-schema#Resource
 */
class rdfs_Resource extends NamedNode {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is ^<http://www.w3.org/1999/02/22-rdf-syntax-ns#predicate>
	 * @returns {?NamedNode}
	 */
	get predicateInverse() {
	}
	
	set predicateInverse(value) {
	}
	
	/**
	 * (No sh:description found)
	 * The RDF path is ^<http://www.w3.org/1999/02/22-rdf-syntax-ns#subject>
	 * @returns {?NamedNode}
	 */
	get subjectInverse() {
	}
	
	set subjectInverse(value) {
	}
}
GraphNodeUtil.classes['rdfs_Resource'] = rdfs_Resource;
Object.defineProperty(rdfs_Resource.prototype, 'predicateInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#predicate>', NamedNode);
	},
	set(value) {
		__jenaData.setPropertyValueInverse(this.zzzJenaNode, 'http://www.w3.org/1999/02/22-rdf-syntax-ns#predicate', value);
	}
});
Object.defineProperty(rdfs_Resource.prototype, 'subjectInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#subject>', NamedNode);
	},
	set(value) {
		__jenaData.setPropertyValueInverse(this.zzzJenaNode, 'http://www.w3.org/1999/02/22-rdf-syntax-ns#subject', value);
	}
});

/**
 * Describes the properties of instances of http://www.w3.org/2000/01/rdf-schema#Resource
 * @typedef rdfs_Resource_Props_Int
 * @property {?NamedNode} [predicateInverse]
 * @property {?NamedNode} [subjectInverse]
 * @typedef {NamedNode_Props & rdfs_Resource_Props_Int} rdfs_Resource_Props
 */

/**
 * Generated from the shape http://www.w3.org/2002/07/owl#Thing
 */
class owl_Thing extends rdfs_Resource {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://purl.org/dc/terms/subject>
	 * @returns {skos_Concept[]}
	 */
	get subject() {
	}
...
GraphNodeUtil.classes['owl_Thing'] = owl_Thing;
Object.defineProperty(owl_Thing.prototype, 'subject', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/dc/terms/subject>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/dc/terms/subject', values, null);
	}
});

/**
 * Describes the properties of instances of http://www.w3.org/2002/07/owl#Thing
 * @typedef owl_Thing_Props_Int
 * @property {skos_Concept[]} [subject]
 * @typedef {rdfs_Resource_Props & owl_Thing_Props_Int} owl_Thing_Props
 */

/**
 * Generated from the shape http://www.w3.org/1999/02/22-rdf-syntax-ns#Property
 */
class rdf_Property extends rdfs_Resource {
 ...
 * @typedef {rdfs_Resource_Props & rdf_Property_Props_Int} rdf_Property_Props
 */

/**
 * Generated from the shape http://www.w3.org/ns/shacl#Parameterizable
 */
class sh_Parameterizable extends rdfs_Resource {
 ...
 * @property {rdfs_Class[]} [types] - The type(s) of this.
 * @typedef {rdfs_Resource_Props & sh_Parameterizable_Props_Int} sh_Parameterizable_Props
 */

/**
 * Generated from the shape http://www.w3.org/ns/shacl#PropertyGroup
 */
class sh_PropertyGroup extends rdfs_Resource {
 ...
 * @typedef {rdfs_Resource_Props & sh_PropertyGroup_Props_Int} sh_PropertyGroup_Props
 */

/**
 * Generated from the shape http://www.w3.org/ns/shacl#Rule
 */
class sh_Rule extends rdfs_Resource {
 ...
 * @property {rdfs_Class[]} [types] - The type(s) of this.
 * @typedef {rdfs_Resource_Props & sh_Rule_Props_Int} sh_Rule_Props
 */

/**
 * Generated from the shape http://www.w3.org/ns/shacl#Shape
 */
class sh_Shape extends rdfs_Resource {
 ...
 * @typedef {rdfs_Resource_Props & sh_Shape_Props_Int} sh_Shape_Props
 */

/**
 * Generated from the shape http://datashapes.org/graphql#Schema
 */
class graphql_Schema extends rdfs_Resource {
 ...
 * @typedef {rdfs_Resource_Props & graphql_Schema_Props_Int} graphql_Schema_Props
 */

/**
 * Generated from the shape http://www.w3.org/2008/05/skos-xl#Label
 */
class skosxl_Label extends owl_Thing {
 ...
 * @typedef {owl_Thing_Props & skosxl_Label_Props_Int} skosxl_Label_Props
 */

/**
 * Generated from the shape http://www.w3.org/2004/02/skos/core#Collection
 */
class skos_Collection extends owl_Thing {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://xmlns.com/foaf/0.1/page>
	 * @returns {LiteralNode[]}
	 */
	get page() {
	}
...
Object.defineProperty(skos_Collection.prototype, 'member', {
	enumerable: true,
	get() {
		return this.values('<http://www.w3.org/2004/02/skos/core#member>', owl_Thing);
	},
	set(values) {
...
Object.defineProperty(skos_Collection.prototype, 'page', {
	enumerable: true,
	get() {
		return this.values('<http://xmlns.com/foaf/0.1/page>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://xmlns.com/foaf/0.1/page', values, 'http://www.w3.org/2001/XMLSchema#anyURI');
	}
});
 ...
 * @property {owl_Thing[]} [member] - Relates a collection to its members, which should be either Concepts or other Collections.
 * @property {LiteralNode[]} [page]
 * @property {rdfs_Class[]} [types] - The type(s) of this.
 * @typedef {owl_Thing_Props & skos_Collection_Props_Int} skos_Collection_Props
 */

/**
 * Generated from the shape http://www.w3.org/2004/02/skos/core#Concept
 */
class skos_Concept extends owl_Thing {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://purl.org/dc/terms/bibliographicCitation>
	 * @returns {(LiteralNode|string)[]}
	 */
	get bibliographicCitation() {
	}
	
	set bibliographicCitation(values) {
	}
	...
	/**
	 * Het concept van "generieke bredere term" in de context van ISO 25964 heeft betrekking op hiërarchische relaties in een thesaurus. De term wordt gebruikt om een concept te definiëren dat algemener is dan het huidige concept in de hiërarchie.
	 * 
	 * Bijvoorbeeld, als we verschillende soorten voertuigen bespreken, kan "auto" worden beschouwd als een "generieke smallere term" van "voertuig". Daarom zou "voertuig" de "generieke bredere term" voor "auto" zijn. Dit komt omdat alle auto's voertuigen zijn, maar niet alle voertuigen zijn auto's.
	 * The RDF path is <http://purl.org/iso25964/skos-thes#broaderGeneric>
	 * @returns {skos_Concept[]}
	 */
	get broaderGeneric() {
	}
	
	set broaderGeneric(values) {
	}
	
	/**
	 * "Instantiële bredere term" in de context van ISO 25964 verwijst naar instantiële relaties in een thesaurus. Een instantiële bredere term verwijst naar een concept dat representeert een klasse of categorie waarvan het huidige concept een instantie of voorbeeld is.
	 * 
	 * Bijvoorbeeld, als we verschillende bekende schilders bespreken, kan "Vincent van Gogh" worden beschouwd als een instantiële smallere term van "Schilders". Daarom zou "Schilders" de "instantiële bredere term" voor "Vincent van Gogh" zijn. Dit komt omdat Vincent van Gogh een schilder is, maar niet alle schilders zijn Vincent van Gogh.
	 * 
	 * Het belangrijkste verschil tussen generieke en instantiële relaties is dat in een generieke relatie, alle smallere termen vallen onder de bredere term. Maar in een instantiële relatie, de smallere term is een instantie of voorbeeld van de bredere term, maar er zijn vele andere mogelijke voorbeelden of instanties die kunnen bestaan.
	 * The RDF path is <http://purl.org/iso25964/skos-thes#broaderInstantial>
	 * @returns {skos_Concept[]}
	 */
	get broaderInstantial() {
	}
	
	set broaderInstantial(values) {
	}
	
	/**
	 * De "partitieve bredere term" in de context van ISO 25964 verwijst naar partitieve relaties in een thesaurus. Een partitieve bredere term verwijst naar een concept dat een geheel of set vormt waarvan het huidige concept een deel of lid is.
	 * 
	 * Als voorbeeld, als we de onderdelen van een auto bespreken, zou "motor" een partitieve smallere term kunnen zijn van "auto". Daarom zou "auto" de "partitieve bredere term" voor "motor" zijn. Dit komt omdat de motor een onderdeel is van de auto, maar niet alle onderdelen van een auto zijn motoren.
	 * 
	 * Het belangrijke verschil tussen generieke, instantiële en partitieve relaties is dat in een partitieve relatie, de smallere term een deel of onderdeel is van de bredere term, terwijl in een generieke relatie, alle smallere termen vallen onder de bredere term, en in een instantiële relatie, de smallere term is een instantie of voorbeeld van de bredere term.
	 * The RDF path is <http://purl.org/iso25964/skos-thes#broaderPartitive>
	 * @returns {skos_Concept[]}
	 */
	get broaderPartitive() {
	}
	
	set broaderPartitive(values) {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://www.w3.org/2004/02/skos/core#inScheme>
	 * @returns {skos_ConceptScheme[]}
	 */
	get inScheme() {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://xmlns.com/foaf/0.1/isPrimaryTopicOf>
	 * @returns {NamedNode[]}
	 */
	get isPrimaryTopicOf() {
	}
	
	set isPrimaryTopicOf(values) {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://www.w3.org/2004/02/skos/core#narrowMatch>
	 * @returns {skos_Concept[]}
	 */
	get narrowMatch() {
	}
	
	set narrowMatch(values) {
	}
	 ...
	 * 
	 * Bijvoorbeeld, als we verschillende soorten voertuigen bespreken, kan "auto" worden beschouwd als een "generieke smallere term" van "voertuig". Daarom zou "voertuig" de "generieke bredere term" voor "auto" zijn. Dit komt omdat alle auto's voertuigen zijn, maar niet alle voertuigen zijn auto's.
	 * The RDF path is <http://purl.org/iso25964/skos-thes#narrowerGeneric>
	 * @returns {skos_Concept[]}
	 */
	get narrowerGeneric() {
	}
	
	set narrowerGeneric(values) {
	}
	 ...
	 * 
	 * Het belangrijkste verschil tussen generieke en instantiële relaties is dat in een generieke relatie, alle smallere termen vallen onder de bredere term. Maar in een instantiële relatie, de smallere term is een instantie of voorbeeld van de bredere term, maar er zijn vele andere mogelijke voorbeelden of instanties die kunnen bestaan.
	 * The RDF path is <http://purl.org/iso25964/skos-thes#narrowerInstantial>
	 * @returns {skos_Concept[]}
	 */
	get narrowerInstantial() {
	}
	
	set narrowerInstantial(values) {
	}
	 ...
	 * 
	 * Het belangrijke verschil tussen generieke, instantiële en partitieve relaties is dat in een partitieve relatie, de smallere term een deel of onderdeel is van de bredere term, terwijl in een generieke relatie, alle smallere termen vallen onder de bredere term, en in een instantiële relatie, de smallere term is een instantie of voorbeeld van de bredere term.
	 * The RDF path is <http://purl.org/iso25964/skos-thes#narrowerPartitive>
	 * @returns {skos_Concept[]}
	 */
	get narrowerPartitive() {
	}
	
	set narrowerPartitive(values) {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://purl.org/dc/terms/source>
	 * @returns {LiteralNode[]}
	 */
	get source() {
	}
...
Object.defineProperty(skos_Concept.prototype, 'bibliographicCitation', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/dc/terms/bibliographicCitation>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/dc/terms/bibliographicCitation', values, null);
	}
});
...
Object.defineProperty(skos_Concept.prototype, 'broaderGeneric', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#broaderGeneric>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#broaderGeneric', values, null);
	}
});
Object.defineProperty(skos_Concept.prototype, 'broaderInstantial', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#broaderInstantial>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#broaderInstantial', values, null);
	}
});
Object.defineProperty(skos_Concept.prototype, 'broaderPartitive', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#broaderPartitive>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#broaderPartitive', values, null);
	}
});
...
Object.defineProperty(skos_Concept.prototype, 'comment', {
	enumerable: true,
	get() {
		return this.values('<http://www.w3.org/2000/01/rdf-schema#comment>', null);
	},
...
Object.defineProperty(skos_Concept.prototype, 'inScheme', {
	enumerable: true,
	get() {
		return this.values('<http://www.w3.org/2004/02/skos/core#inScheme>', skos_ConceptScheme);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://www.w3.org/2004/02/skos/core#inScheme', values, null);
	}
});
Object.defineProperty(skos_Concept.prototype, 'isPrimaryTopicOf', {
	enumerable: true,
	get() {
		return this.values('<http://xmlns.com/foaf/0.1/isPrimaryTopicOf>', NamedNode);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://xmlns.com/foaf/0.1/isPrimaryTopicOf', values, null);
	}
});
Object.defineProperty(skos_Concept.prototype, 'label', {
	enumerable: true,
	get() {
		return this.values('<http://www.w3.org/2000/01/rdf-schema#label>', null);
	},
...
Object.defineProperty(skos_Concept.prototype, 'narrowMatch', {
	enumerable: true,
	get() {
		return this.values('<http://www.w3.org/2004/02/skos/core#narrowMatch>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://www.w3.org/2004/02/skos/core#narrowMatch', values, null);
	}
});
...
Object.defineProperty(skos_Concept.prototype, 'narrowerGeneric', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#narrowerGeneric>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#narrowerGeneric', values, null);
	}
});
Object.defineProperty(skos_Concept.prototype, 'narrowerInstantial', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#narrowerInstantial>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#narrowerInstantial', values, null);
	}
});
Object.defineProperty(skos_Concept.prototype, 'narrowerPartitive', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#narrowerPartitive>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#narrowerPartitive', values, null);
	}
});
...
Object.defineProperty(skos_Concept.prototype, 'page', {
	enumerable: true,
	get() {
		return this.values('<http://xmlns.com/foaf/0.1/page>', null);
	},
...
Object.defineProperty(skos_Concept.prototype, 'source', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/dc/terms/source>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/dc/terms/source', values, 'http://www.w3.org/2001/XMLSchema#anyURI');
	}
});
Object.defineProperty(skos_Concept.prototype, 'subjectInverse', {
	enumerable: true,
	get() {
		return this.values('^<http://purl.org/dc/terms/subject>', rdfs_Resource);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValuesInverse' : 'setPropertyValueInverse'](this.zzzJenaNode, 'http://purl.org/dc/terms/subject', values);
	}
});
 ...
 * @property {(LiteralNode|string)[]} [bibliographicCitation]
 ...
 * @property {skos_Concept[]} [broaderGeneric] - Het concept van "generieke bredere term" in de context van ISO 25964 heeft betrekking op hiërarchische relaties in een thesaurus. De term wordt gebruikt om een concept te definiëren dat algemener is dan het huidige concept in de hiërarchie.
 *   
 *   Bijvoorbeeld, als we verschillende soorten voertuigen bespreken, kan "auto" worden beschouwd als een "generieke smallere term" van "voertuig". Daarom zou "voertuig" de "generieke bredere term" voor "auto" zijn. Dit komt omdat alle auto's voertuigen zijn, maar niet alle voertuigen zijn auto's.
 * @property {skos_Concept[]} [broaderInstantial] - "Instantiële bredere term" in de context van ISO 25964 verwijst naar instantiële relaties in een thesaurus. Een instantiële bredere term verwijst naar een concept dat representeert een klasse of categorie waarvan het huidige concept een instantie of voorbeeld is.
 *   
 *   Bijvoorbeeld, als we verschillende bekende schilders bespreken, kan "Vincent van Gogh" worden beschouwd als een instantiële smallere term van "Schilders". Daarom zou "Schilders" de "instantiële bredere term" voor "Vincent van Gogh" zijn. Dit komt omdat Vincent van Gogh een schilder is, maar niet alle schilders zijn Vincent van Gogh.
 *   
 *   Het belangrijkste verschil tussen generieke en instantiële relaties is dat in een generieke relatie, alle smallere termen vallen onder de bredere term. Maar in een instantiële relatie, de smallere term is een instantie of voorbeeld van de bredere term, maar er zijn vele andere mogelijke voorbeelden of instanties die kunnen bestaan.
 * @property {skos_Concept[]} [broaderPartitive] - De "partitieve bredere term" in de context van ISO 25964 verwijst naar partitieve relaties in een thesaurus. Een partitieve bredere term verwijst naar een concept dat een geheel of set vormt waarvan het huidige concept een deel of lid is.
 *   
 *   Als voorbeeld, als we de onderdelen van een auto bespreken, zou "motor" een partitieve smallere term kunnen zijn van "auto". Daarom zou "auto" de "partitieve bredere term" voor "motor" zijn. Dit komt omdat de motor een onderdeel is van de auto, maar niet alle onderdelen van een auto zijn motoren.
 *   
 *   Het belangrijke verschil tussen generieke, instantiële en partitieve relaties is dat in een partitieve relatie, de smallere term een deel of onderdeel is van de bredere term, terwijl in een generieke relatie, alle smallere termen vallen onder de bredere term, en in een instantiële relatie, de smallere term is een instantie of voorbeeld van de bredere term.
 ...
 * @property {skos_ConceptScheme[]} [inScheme]
 * @property {NamedNode[]} [isPrimaryTopicOf]
 * @property {(LiteralNode|string)[]} [label]
 * @property {skos_Concept[]} [narrowMatch]
 * @property {skos_Concept[]} [narrower] - Relates a concept to a concept that is more specific in meaning.
 * @property {skos_Concept[]} [narrowerGeneric] - Het concept van "generieke bredere term" in de context van ISO 25964 heeft betrekking op hiërarchische relaties in een thesaurus. De term wordt gebruikt om een concept te definiëren dat algemener is dan het huidige concept in de hiërarchie.
 *   
 *   Bijvoorbeeld, als we verschillende soorten voertuigen bespreken, kan "auto" worden beschouwd als een "generieke smallere term" van "voertuig". Daarom zou "voertuig" de "generieke bredere term" voor "auto" zijn. Dit komt omdat alle auto's voertuigen zijn, maar niet alle voertuigen zijn auto's.
 * @property {skos_Concept[]} [narrowerInstantial] - "Instantiële bredere term" in de context van ISO 25964 verwijst naar instantiële relaties in een thesaurus. Een instantiële bredere term verwijst naar een concept dat representeert een klasse of categorie waarvan het huidige concept een instantie of voorbeeld is.
 *   
 *   Bijvoorbeeld, als we verschillende bekende schilders bespreken, kan "Vincent van Gogh" worden beschouwd als een instantiële smallere term van "Schilders". Daarom zou "Schilders" de "instantiële bredere term" voor "Vincent van Gogh" zijn. Dit komt omdat Vincent van Gogh een schilder is, maar niet alle schilders zijn Vincent van Gogh.
 *   
 *   Het belangrijkste verschil tussen generieke en instantiële relaties is dat in een generieke relatie, alle smallere termen vallen onder de bredere term. Maar in een instantiële relatie, de smallere term is een instantie of voorbeeld van de bredere term, maar er zijn vele andere mogelijke voorbeelden of instanties die kunnen bestaan.
 * @property {skos_Concept[]} [narrowerPartitive] - De "partitieve bredere term" in de context van ISO 25964 verwijst naar partitieve relaties in een thesaurus. Een partitieve bredere term verwijst naar een concept dat een geheel of set vormt waarvan het huidige concept een deel of lid is.
 *   
 *   Als voorbeeld, als we de onderdelen van een auto bespreken, zou "motor" een partitieve smallere term kunnen zijn van "auto". Daarom zou "auto" de "partitieve bredere term" voor "motor" zijn. Dit komt omdat de motor een onderdeel is van de auto, maar niet alle onderdelen van een auto zijn motoren.
 *   
 *   Het belangrijke verschil tussen generieke, instantiële en partitieve relaties is dat in een partitieve relatie, de smallere term een deel of onderdeel is van de bredere term, terwijl in een generieke relatie, alle smallere termen vallen onder de bredere term, en in een instantiële relatie, de smallere term is een instantie of voorbeeld van de bredere term.
 ...
 * @property {LiteralNode[]} [source]
 * @property {rdfs_Resource[]} [subjectInverse]
 * @property {skos_ConceptScheme[]} [topConceptOf]
 * @typedef {owl_Thing_Props & skos_Concept_Props_Int} skos_Concept_Props
 */

/**
 * Generated from the shape http://www.w3.org/2004/02/skos/core#ConceptScheme
 */
class skos_ConceptScheme extends owl_Thing {
...
Object.defineProperty(skos_ConceptScheme.prototype, 'source', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/dc/terms/source>', null);
	},
 ...
 * @property {LiteralNode[]} [source]
 * @typedef {owl_Thing_Props & skos_ConceptScheme_Props_Int} skos_ConceptScheme_Props
 */

/**
 * Generated from the shape http://www.w3.org/2000/01/rdf-schema#Class
 */
class rdfs_Class extends owl_Thing {
...
Object.defineProperty(rdfs_Class.prototype, 'predicateInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#predicate>', NamedNode);
	},
...
Object.defineProperty(rdfs_Class.prototype, 'subjectInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#subject>', NamedNode);
	},
 ...
 * @property {rdfs_Class[]} [types] - The type(s) of this.
 * @typedef {owl_Thing_Props & rdfs_Class_Props_Int} rdfs_Class_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ArchimateModelElement
 */
class archimate_ArchimateModelElement extends owl_Thing {
...
GraphNodeUtil.classes['archimate_ArchimateModelElement'] = archimate_ArchimateModelElement;
Object.defineProperty(archimate_ArchimateModelElement.prototype, 'comment', {
	enumerable: true,
	get() {
		return this.values('<http://www.w3.org/2000/01/rdf-schema#comment>', null);
	},
...
Object.defineProperty(archimate_ArchimateModelElement.prototype, 'labels', {
	enumerable: true,
	get() {
		return this.values('<http://www.w3.org/2000/01/rdf-schema#label>', null);
	},
...
Object.defineProperty(archimate_ArchimateModelElement.prototype, 'types', {
	enumerable: true,
	get() {
		return this.values('<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>', rdfs_Class);
	},
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ArchimateModelElement
 * @typedef archimate_ArchimateModelElement_Props_Int
 * @property {(LiteralNode|LiteralNode|string)[]} [comment]
 * @property {(LiteralNode|string)[]} [labels]
 * @property {rdfs_Class[]} [types]
 * @typedef {owl_Thing_Props & archimate_ArchimateModelElement_Props_Int} archimate_ArchimateModelElement_Props
 */
...
Object.defineProperty(owl_Ontology.prototype, 'predicateInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#predicate>', NamedNode);
	},
...
Object.defineProperty(owl_Ontology.prototype, 'subjectInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#subject>', NamedNode);
	},
...
/**
 * Generated from the shape http://purl.org/iso25964/skos-thes#ConceptGroup
 */
class skosthes_ConceptGroup extends skos_Collection {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://purl.org/iso25964/skos-thes#microThesaurusOf>
	 * @returns {skos_ConceptScheme[]}
	 */
	get microThesaurusOf() {
	}
	
	set microThesaurusOf(values) {
	}
	
	/**
	 * (No sh:description found)
	 * The RDF path is <http://purl.org/iso25964/skos-thes#subGroup>
	 * @returns {skosthes_ConceptGroup[]}
	 */
	get subGroup() {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://purl.org/iso25964/skos-thes#superGroup>
	 * @returns {skosthes_ConceptGroup[]}
	 */
	get superGroup() {
	}
	
	set superGroup(values) {
	}
}
GraphNodeUtil.classes['skosthes_ConceptGroup'] = skosthes_ConceptGroup;
Object.defineProperty(skosthes_ConceptGroup.prototype, 'microThesaurusOf', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#microThesaurusOf>', skos_ConceptScheme);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#microThesaurusOf', values, null);
	}
});
Object.defineProperty(skosthes_ConceptGroup.prototype, 'subGroup', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#subGroup>', skosthes_ConceptGroup);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#subGroup', values, null);
	}
});
Object.defineProperty(skosthes_ConceptGroup.prototype, 'superGroup', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#superGroup>', skosthes_ConceptGroup);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#superGroup', values, null);
	}
});

/**
 * Describes the properties of instances of http://purl.org/iso25964/skos-thes#ConceptGroup
 * @typedef skosthes_ConceptGroup_Props_Int
 * @property {skos_ConceptScheme[]} [microThesaurusOf]
 * @property {skosthes_ConceptGroup[]} [subGroup]
 * @property {skosthes_ConceptGroup[]} [superGroup]
 * @typedef {skos_Collection_Props & skosthes_ConceptGroup_Props_Int} skosthes_ConceptGroup_Props
 */

/**
 * Generated from the shape http://purl.org/iso25964/skos-thes#ThesaurusArray
 */
class skosthes_ThesaurusArray extends skos_Collection {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://purl.org/iso25964/skos-thes#superOrdinate>
	 * @returns {skos_Concept[]}
	 */
	get superOrdinate() {
	}
	
	set superOrdinate(values) {
	}
}
GraphNodeUtil.classes['skosthes_ThesaurusArray'] = skosthes_ThesaurusArray;
Object.defineProperty(skosthes_ThesaurusArray.prototype, 'superOrdinate', {
	enumerable: true,
	get() {
		return this.values('<http://purl.org/iso25964/skos-thes#superOrdinate>', skos_Concept);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://purl.org/iso25964/skos-thes#superOrdinate', values, null);
	}
});

/**
 * Describes the properties of instances of http://purl.org/iso25964/skos-thes#ThesaurusArray
 * @typedef skosthes_ThesaurusArray_Props_Int
 * @property {skos_Concept[]} [superOrdinate]
 * @typedef {skos_Collection_Props & skosthes_ThesaurusArray_Props_Int} skosthes_ThesaurusArray_Props
 */
...
Object.defineProperty(sh_TargetType.prototype, 'predicateInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#predicate>', NamedNode);
	},
...
Object.defineProperty(sh_TargetType.prototype, 'subjectInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#subject>', NamedNode);
	},
...
Object.defineProperty(dash_ShapeClass.prototype, 'predicateInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#predicate>', NamedNode);
	},
...
Object.defineProperty(dash_ShapeClass.prototype, 'subjectInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#subject>', NamedNode);
	},
...
/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ApplicationCollaboration
 */
class archimate_ApplicationCollaboration extends archimate_ArchimateModelElement {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#aggregation>
	 * @returns {?archimate_ApplicationComponent}
	 */
	get aggregation() {
	}
...
GraphNodeUtil.classes['archimate_ApplicationCollaboration'] = archimate_ApplicationCollaboration;
Object.defineProperty(archimate_ApplicationCollaboration.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#aggregation>', archimate_ApplicationComponent);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', value, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ApplicationCollaboration
 * @typedef archimate_ApplicationCollaboration_Props_Int
 * @property {?archimate_ApplicationComponent} [aggregation]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ApplicationCollaboration_Props_Int} archimate_ApplicationCollaboration_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ApplicationComponent
 */
class archimate_ApplicationComponent extends archimate_ArchimateModelElement {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#assignment>
	 * @returns {archimate_ApplicationFunction[]}
	 */
	get assignment() {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#association>
	 * @returns {NamedNode[]}
	 */
	get association() {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#flow>
	 * @returns {archimate_ApplicationComponent[]}
	 */
	get flow() {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#realization>
	 * @returns {NamedNode[]}
	 */
	get realization() {
	}
	
	set realization(values) {
	}
	
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#serving>
	 * @returns {?archimate_BusinessService}
	 */
	get serving() {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#specialization>
	 * @returns {archimate_ApplicationComponent[]}
	 */
	get specialization() {
	}
...
GraphNodeUtil.classes['archimate_ApplicationComponent'] = archimate_ApplicationComponent;
Object.defineProperty(archimate_ApplicationComponent.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', values, null);
	}
});
Object.defineProperty(archimate_ApplicationComponent.prototype, 'assignment', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#assignment>', archimate_ApplicationFunction);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#assignment', values, null);
	}
});
Object.defineProperty(archimate_ApplicationComponent.prototype, 'association', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#association>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#association', values, null);
	}
});
Object.defineProperty(archimate_ApplicationComponent.prototype, 'flow', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#flow>', archimate_ApplicationComponent);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#flow', values, null);
	}
});
Object.defineProperty(archimate_ApplicationComponent.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#realization>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', values, null);
	}
});
Object.defineProperty(archimate_ApplicationComponent.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#serving>', archimate_BusinessService);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#serving', value, null);
	}
});
Object.defineProperty(archimate_ApplicationComponent.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#specialization>', archimate_ApplicationComponent);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', values, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ApplicationComponent
 * @typedef archimate_ApplicationComponent_Props_Int
 * @property {NamedNode[]} [aggregation]
 * @property {archimate_ApplicationFunction[]} [assignment]
 * @property {NamedNode[]} [association]
 * @property {archimate_ApplicationComponent[]} [flow]
 * @property {NamedNode[]} [realization]
 * @property {?archimate_BusinessService} [serving]
 * @property {archimate_ApplicationComponent[]} [specialization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ApplicationComponent_Props_Int} archimate_ApplicationComponent_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ApplicationEvent
 */
class archimate_ApplicationEvent extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_ApplicationEvent'] = archimate_ApplicationEvent;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ApplicationEvent
 * @typedef archimate_ApplicationEvent_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ApplicationEvent_Props_Int} archimate_ApplicationEvent_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ApplicationFunction
 */
class archimate_ApplicationFunction extends archimate_ArchimateModelElement {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#composition>
	 * @returns {?archimate_ApplicationFunction}
	 */
	get composition() {
	}
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#readWriteAccess>
	 * @returns {?archimate_DataObject}
	 */
	get readWriteAccess() {
	}
	
	set readWriteAccess(value) {
	}
...
GraphNodeUtil.classes['archimate_ApplicationFunction'] = archimate_ApplicationFunction;
Object.defineProperty(archimate_ApplicationFunction.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#aggregation>', archimate_ApplicationFunction);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', value, null);
	}
});
Object.defineProperty(archimate_ApplicationFunction.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#composition>', archimate_ApplicationFunction);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#composition', value, null);
	}
});
Object.defineProperty(archimate_ApplicationFunction.prototype, 'flow', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#flow>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#flow', values, null);
	}
});
Object.defineProperty(archimate_ApplicationFunction.prototype, 'readWriteAccess', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#readWriteAccess>', archimate_DataObject);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#readWriteAccess', value, null);
	}
});
Object.defineProperty(archimate_ApplicationFunction.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#realization>', archimate_ApplicationService);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', values, null);
	}
});
Object.defineProperty(archimate_ApplicationFunction.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#serving>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#serving', values, null);
	}
});
Object.defineProperty(archimate_ApplicationFunction.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#specialization>', archimate_ApplicationFunction);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', value, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ApplicationFunction
 * @typedef archimate_ApplicationFunction_Props_Int
 * @property {?archimate_ApplicationFunction} [aggregation]
 * @property {?archimate_ApplicationFunction} [composition]
 * @property {NamedNode[]} [flow]
 * @property {?archimate_DataObject} [readWriteAccess]
 * @property {archimate_ApplicationService[]} [realization]
 * @property {NamedNode[]} [serving]
 * @property {?archimate_ApplicationFunction} [specialization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ApplicationFunction_Props_Int} archimate_ApplicationFunction_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ApplicationInteraction
 */
class archimate_ApplicationInteraction extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_ApplicationInteraction'] = archimate_ApplicationInteraction;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ApplicationInteraction
 * @typedef archimate_ApplicationInteraction_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ApplicationInteraction_Props_Int} archimate_ApplicationInteraction_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ApplicationInterface
 */
class archimate_ApplicationInterface extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_ApplicationInterface'] = archimate_ApplicationInterface;
Object.defineProperty(archimate_ApplicationInterface.prototype, 'assignment', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#assignment>', archimate_ApplicationService);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#assignment', value, null);
	}
});
Object.defineProperty(archimate_ApplicationInterface.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#serving>', archimate_ApplicationComponent);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#serving', value, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ApplicationInterface
 * @typedef archimate_ApplicationInterface_Props_Int
 * @property {?archimate_ApplicationService} [assignment]
 * @property {?archimate_ApplicationComponent} [serving]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ApplicationInterface_Props_Int} archimate_ApplicationInterface_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ApplicationProcess
 */
class archimate_ApplicationProcess extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_ApplicationProcess'] = archimate_ApplicationProcess;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ApplicationProcess
 * @typedef archimate_ApplicationProcess_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ApplicationProcess_Props_Int} archimate_ApplicationProcess_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ApplicationService
 */
class archimate_ApplicationService extends archimate_ArchimateModelElement {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#writeAccess>
	 * @returns {?archimate_DataObject}
	 */
	get writeAccess() {
	}
...
GraphNodeUtil.classes['archimate_ApplicationService'] = archimate_ApplicationService;
Object.defineProperty(archimate_ApplicationService.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#aggregation>', archimate_ApplicationService);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', value, null);
	}
});
Object.defineProperty(archimate_ApplicationService.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#composition>', archimate_ApplicationService);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#composition', values, null);
	}
});
Object.defineProperty(archimate_ApplicationService.prototype, 'flow', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#flow>', null);
	},
...
Object.defineProperty(archimate_ApplicationService.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#realization>', archimate_Constraint);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', value, null);
	}
});
Object.defineProperty(archimate_ApplicationService.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#serving>', null);
	},
...
Object.defineProperty(archimate_ApplicationService.prototype, 'writeAccess', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#writeAccess>', archimate_DataObject);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#writeAccess', value, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ApplicationService
 * @typedef archimate_ApplicationService_Props_Int
 * @property {?archimate_ApplicationService} [aggregation]
 * @property {archimate_ApplicationService[]} [composition]
 * @property {NamedNode[]} [flow]
 * @property {?archimate_Constraint} [realization]
 * @property {NamedNode[]} [serving]
 * @property {?archimate_DataObject} [writeAccess]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ApplicationService_Props_Int} archimate_ApplicationService_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Artifact
 */
class archimate_Artifact extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Artifact'] = archimate_Artifact;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Artifact
 * @typedef archimate_Artifact_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Artifact_Props_Int} archimate_Artifact_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Assessment
 */
class archimate_Assessment extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Assessment'] = archimate_Assessment;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Assessment
 * @typedef archimate_Assessment_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Assessment_Props_Int} archimate_Assessment_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessActor
 */
class archimate_BusinessActor extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_BusinessActor'] = archimate_BusinessActor;
Object.defineProperty(archimate_BusinessActor.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', archimate_Grouping);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', values, null);
	}
});
Object.defineProperty(archimate_BusinessActor.prototype, 'assignment', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#assignment>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#assignment', values, null);
	}
});
Object.defineProperty(archimate_BusinessActor.prototype, 'association', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#association>', archimate_ApplicationComponent);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#association', values, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessActor
 * @typedef archimate_BusinessActor_Props_Int
 * @property {archimate_Grouping[]} [aggregation]
 * @property {NamedNode[]} [assignment]
 * @property {archimate_ApplicationComponent[]} [association]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessActor_Props_Int} archimate_BusinessActor_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessCollaboration
 */
class archimate_BusinessCollaboration extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_BusinessCollaboration'] = archimate_BusinessCollaboration;
Object.defineProperty(archimate_BusinessCollaboration.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#aggregation>', null);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', value, null);
	}
});
Object.defineProperty(archimate_BusinessCollaboration.prototype, 'assignment', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#assignment>', archimate_BusinessProcess);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#assignment', values, null);
	}
});
Object.defineProperty(archimate_BusinessCollaboration.prototype, 'association', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#association>', archimate_ApplicationComponent);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#association', value, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessCollaboration
 * @typedef archimate_BusinessCollaboration_Props_Int
 * @property {?NamedNode} [aggregation]
 * @property {archimate_BusinessProcess[]} [assignment]
 * @property {?archimate_ApplicationComponent} [association]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessCollaboration_Props_Int} archimate_BusinessCollaboration_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessEvent
 */
class archimate_BusinessEvent extends archimate_ArchimateModelElement {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#triggering>
	 * @returns {archimate_BusinessProcess[]}
	 */
	get triggering() {
	}
	
	set triggering(values) {
	}
}
GraphNodeUtil.classes['archimate_BusinessEvent'] = archimate_BusinessEvent;
Object.defineProperty(archimate_BusinessEvent.prototype, 'triggering', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#triggering>', archimate_BusinessProcess);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#triggering', values, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessEvent
 * @typedef archimate_BusinessEvent_Props_Int
 * @property {archimate_BusinessProcess[]} [triggering]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessEvent_Props_Int} archimate_BusinessEvent_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessFunction
 */
class archimate_BusinessFunction extends archimate_ArchimateModelElement {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#readAccess>
	 * @returns {?archimate_BusinessObject}
	 */
	get readAccess() {
	}
	...
	set writeAccess(values) {
	}
}
GraphNodeUtil.classes['archimate_BusinessFunction'] = archimate_BusinessFunction;
Object.defineProperty(archimate_BusinessFunction.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', null);
	},
...
Object.defineProperty(archimate_BusinessFunction.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#composition>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#composition', values, null);
	}
});
Object.defineProperty(archimate_BusinessFunction.prototype, 'flow', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#flow>', null);
	},
...
Object.defineProperty(archimate_BusinessFunction.prototype, 'readAccess', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#readAccess>', archimate_BusinessObject);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#readAccess', value, null);
	}
});
Object.defineProperty(archimate_BusinessFunction.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#realization>', archimate_Grouping);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', values, null);
	}
});
Object.defineProperty(archimate_BusinessFunction.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#serving>', null);
	},
...
Object.defineProperty(archimate_BusinessFunction.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#specialization>', archimate_BusinessFunction);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', value, null);
	}
});
Object.defineProperty(archimate_BusinessFunction.prototype, 'triggering', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#triggering>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#triggering', values, null);
	}
});
Object.defineProperty(archimate_BusinessFunction.prototype, 'writeAccess', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#writeAccess>', archimate_BusinessObject);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#writeAccess', values, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessFunction
 * @typedef archimate_BusinessFunction_Props_Int
 * @property {NamedNode[]} [aggregation]
 * @property {NamedNode[]} [composition]
 * @property {NamedNode[]} [flow]
 * @property {?archimate_BusinessObject} [readAccess]
 * @property {archimate_Grouping[]} [realization]
 * @property {NamedNode[]} [serving]
 * @property {?archimate_BusinessFunction} [specialization]
 * @property {NamedNode[]} [triggering]
 * @property {archimate_BusinessObject[]} [writeAccess]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessFunction_Props_Int} archimate_BusinessFunction_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessInteraction
 */
class archimate_BusinessInteraction extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_BusinessInteraction'] = archimate_BusinessInteraction;
Object.defineProperty(archimate_BusinessInteraction.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#serving>', archimate_BusinessProcess);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#serving', values, null);
	}
});
Object.defineProperty(archimate_BusinessInteraction.prototype, 'triggering', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#triggering>', archimate_BusinessInteraction);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#triggering', value, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessInteraction
 * @typedef archimate_BusinessInteraction_Props_Int
 * @property {archimate_BusinessProcess[]} [serving]
 * @property {?archimate_BusinessInteraction} [triggering]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessInteraction_Props_Int} archimate_BusinessInteraction_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessInterface
 */
class archimate_BusinessInterface extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_BusinessInterface'] = archimate_BusinessInterface;
Object.defineProperty(archimate_BusinessInterface.prototype, 'assignment', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#assignment>', archimate_BusinessService);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#assignment', values, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessInterface
 * @typedef archimate_BusinessInterface_Props_Int
 * @property {archimate_BusinessService[]} [assignment]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessInterface_Props_Int} archimate_BusinessInterface_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessObject
 */
class archimate_BusinessObject extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_BusinessObject'] = archimate_BusinessObject;
Object.defineProperty(archimate_BusinessObject.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', archimate_BusinessObject);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', values, null);
	}
});
Object.defineProperty(archimate_BusinessObject.prototype, 'association', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#association>', archimate_BusinessObject);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#association', value, null);
	}
});
Object.defineProperty(archimate_BusinessObject.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#composition>', archimate_BusinessObject);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#composition', values, null);
	}
});
Object.defineProperty(archimate_BusinessObject.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#realization>', archimate_Constraint);
	},
...
Object.defineProperty(archimate_BusinessObject.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#specialization>', archimate_BusinessObject);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', values, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessObject
 * @typedef archimate_BusinessObject_Props_Int
 * @property {archimate_BusinessObject[]} [aggregation]
 * @property {?archimate_BusinessObject} [association]
 * @property {archimate_BusinessObject[]} [composition]
 * @property {?archimate_Constraint} [realization]
 * @property {archimate_BusinessObject[]} [specialization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessObject_Props_Int} archimate_BusinessObject_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessProcess
 */
class archimate_BusinessProcess extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_BusinessProcess'] = archimate_BusinessProcess;
Object.defineProperty(archimate_BusinessProcess.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', null);
	},
...
Object.defineProperty(archimate_BusinessProcess.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#composition>', null);
	},
...
Object.defineProperty(archimate_BusinessProcess.prototype, 'flow', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#flow>', null);
	},
...
Object.defineProperty(archimate_BusinessProcess.prototype, 'readAccess', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#readAccess>', archimate_BusinessObject);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#readAccess', values, null);
	}
});
Object.defineProperty(archimate_BusinessProcess.prototype, 'readWriteAccess', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#readWriteAccess>', archimate_BusinessObject);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#readWriteAccess', value, null);
	}
});
Object.defineProperty(archimate_BusinessProcess.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#realization>', archimate_BusinessService);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', values, null);
	}
});
Object.defineProperty(archimate_BusinessProcess.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#specialization>', archimate_BusinessProcess);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', value, null);
	}
});
Object.defineProperty(archimate_BusinessProcess.prototype, 'triggering', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#triggering>', null);
	},
...
Object.defineProperty(archimate_BusinessProcess.prototype, 'writeAccess', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#writeAccess>', archimate_BusinessObject);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#writeAccess', value, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessProcess
 * @typedef archimate_BusinessProcess_Props_Int
 * @property {NamedNode[]} [aggregation]
 * @property {NamedNode[]} [composition]
 * @property {NamedNode[]} [flow]
 * @property {archimate_BusinessObject[]} [readAccess]
 * @property {?archimate_BusinessObject} [readWriteAccess]
 * @property {archimate_BusinessService[]} [realization]
 * @property {?archimate_BusinessProcess} [specialization]
 * @property {NamedNode[]} [triggering]
 * @property {?archimate_BusinessObject} [writeAccess]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessProcess_Props_Int} archimate_BusinessProcess_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessRole
 */
class archimate_BusinessRole extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_BusinessRole'] = archimate_BusinessRole;
Object.defineProperty(archimate_BusinessRole.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#aggregation>', archimate_BusinessRole);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', value, null);
	}
});
Object.defineProperty(archimate_BusinessRole.prototype, 'assignment', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#assignment>', archimate_BusinessProcess);
	},
...
Object.defineProperty(archimate_BusinessRole.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#realization>', archimate_BusinessService);
	},
...
Object.defineProperty(archimate_BusinessRole.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#specialization>', archimate_BusinessRole);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', values, null);
	}
});
Object.defineProperty(archimate_BusinessRole.prototype, 'writeAccess', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#writeAccess>', archimate_BusinessObject);
	},
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessRole
 * @typedef archimate_BusinessRole_Props_Int
 * @property {?archimate_BusinessRole} [aggregation]
 * @property {archimate_BusinessProcess[]} [assignment]
 * @property {archimate_BusinessService[]} [realization]
 * @property {archimate_BusinessRole[]} [specialization]
 * @property {?archimate_BusinessObject} [writeAccess]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessRole_Props_Int} archimate_BusinessRole_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#BusinessService
 */
class archimate_BusinessService extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_BusinessService'] = archimate_BusinessService;
Object.defineProperty(archimate_BusinessService.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', archimate_BusinessService);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', values, null);
	}
});
Object.defineProperty(archimate_BusinessService.prototype, 'flow', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#flow>', archimate_BusinessProcess);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#flow', values, null);
	}
});
Object.defineProperty(archimate_BusinessService.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#serving>', null);
	},
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#BusinessService
 * @typedef archimate_BusinessService_Props_Int
 * @property {archimate_BusinessService[]} [aggregation]
 * @property {archimate_BusinessProcess[]} [flow]
 * @property {NamedNode[]} [serving]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_BusinessService_Props_Int} archimate_BusinessService_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Capability
 */
class archimate_Capability extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Capability'] = archimate_Capability;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Capability
 * @typedef archimate_Capability_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Capability_Props_Int} archimate_Capability_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#CommunicationNetwork
 */
class archimate_CommunicationNetwork extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_CommunicationNetwork'] = archimate_CommunicationNetwork;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#CommunicationNetwork
 * @typedef archimate_CommunicationNetwork_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_CommunicationNetwork_Props_Int} archimate_CommunicationNetwork_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Constraint
 */
class archimate_Constraint extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Constraint'] = archimate_Constraint;
Object.defineProperty(archimate_Constraint.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#aggregation>', archimate_Constraint);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', value, null);
	}
});
Object.defineProperty(archimate_Constraint.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#specialization>', archimate_Constraint);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', value, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Constraint
 * @typedef archimate_Constraint_Props_Int
 * @property {?archimate_Constraint} [aggregation]
 * @property {?archimate_Constraint} [specialization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Constraint_Props_Int} archimate_Constraint_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Contract
 */
class archimate_Contract extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Contract'] = archimate_Contract;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Contract
 * @typedef archimate_Contract_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Contract_Props_Int} archimate_Contract_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#CourseOfAction
 */
class archimate_CourseOfAction extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_CourseOfAction'] = archimate_CourseOfAction;
Object.defineProperty(archimate_CourseOfAction.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#realization>', archimate_Goal);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', value, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#CourseOfAction
 * @typedef archimate_CourseOfAction_Props_Int
 * @property {?archimate_Goal} [realization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_CourseOfAction_Props_Int} archimate_CourseOfAction_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#DataObject
 */
class archimate_DataObject extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_DataObject'] = archimate_DataObject;
Object.defineProperty(archimate_DataObject.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#aggregation>', archimate_DataObject);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', value, null);
	}
});
Object.defineProperty(archimate_DataObject.prototype, 'association', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#association>', archimate_DataObject);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#association', value, null);
	}
});
Object.defineProperty(archimate_DataObject.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#composition>', archimate_DataObject);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#composition', values, null);
	}
});
Object.defineProperty(archimate_DataObject.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#realization>', archimate_BusinessObject);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', values, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#DataObject
 * @typedef archimate_DataObject_Props_Int
 * @property {?archimate_DataObject} [aggregation]
 * @property {?archimate_DataObject} [association]
 * @property {archimate_DataObject[]} [composition]
 * @property {archimate_BusinessObject[]} [realization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_DataObject_Props_Int} archimate_DataObject_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Deliverable
 */
class archimate_Deliverable extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Deliverable'] = archimate_Deliverable;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Deliverable
 * @typedef archimate_Deliverable_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Deliverable_Props_Int} archimate_Deliverable_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Device
 */
class archimate_Device extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Device'] = archimate_Device;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Device
 * @typedef archimate_Device_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Device_Props_Int} archimate_Device_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#DistributionNetwork
 */
class archimate_DistributionNetwork extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_DistributionNetwork'] = archimate_DistributionNetwork;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#DistributionNetwork
 * @typedef archimate_DistributionNetwork_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_DistributionNetwork_Props_Int} archimate_DistributionNetwork_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Driver
 */
class archimate_Driver extends archimate_ArchimateModelElement {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is <http://bp4mc2.org/def/archimate#influence>
	 * @returns {NamedNode[]}
	 */
	get influence() {
	}
	
	set influence(values) {
	}
}
GraphNodeUtil.classes['archimate_Driver'] = archimate_Driver;
Object.defineProperty(archimate_Driver.prototype, 'association', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#association>', archimate_Resource);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#association', value, null);
	}
});
Object.defineProperty(archimate_Driver.prototype, 'influence', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#influence>', null);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#influence', values, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Driver
 * @typedef archimate_Driver_Props_Int
 * @property {?archimate_Resource} [association]
 * @property {NamedNode[]} [influence]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Driver_Props_Int} archimate_Driver_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Equipment
 */
class archimate_Equipment extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Equipment'] = archimate_Equipment;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Equipment
 * @typedef archimate_Equipment_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Equipment_Props_Int} archimate_Equipment_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Facility
 */
class archimate_Facility extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Facility'] = archimate_Facility;
Object.defineProperty(archimate_Facility.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#composition>', null);
	},
...
Object.defineProperty(archimate_Facility.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#realization>', archimate_TechnologyService);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', values, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Facility
 * @typedef archimate_Facility_Props_Int
 * @property {NamedNode[]} [composition]
 * @property {archimate_TechnologyService[]} [realization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Facility_Props_Int} archimate_Facility_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Gap
 */
class archimate_Gap extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Gap'] = archimate_Gap;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Gap
 * @typedef archimate_Gap_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Gap_Props_Int} archimate_Gap_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Goal
 */
class archimate_Goal extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Goal'] = archimate_Goal;
Object.defineProperty(archimate_Goal.prototype, 'influence', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#influence>', archimate_Assessment);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#influence', value, null);
	}
});

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Goal
 * @typedef archimate_Goal_Props_Int
 * @property {?archimate_Assessment} [influence]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Goal_Props_Int} archimate_Goal_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Grouping
 */
class archimate_Grouping extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Grouping'] = archimate_Grouping;
Object.defineProperty(archimate_Grouping.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', null);
	},
...
Object.defineProperty(archimate_Grouping.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#composition>', null);
	},
...
Object.defineProperty(archimate_Grouping.prototype, 'influence', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#influence>', archimate_Grouping);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#influence', values, null);
	}
});
Object.defineProperty(archimate_Grouping.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#realization>', archimate_Grouping);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', value, null);
	}
});
Object.defineProperty(archimate_Grouping.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#serving>', null);
	},
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Grouping
 * @typedef archimate_Grouping_Props_Int
 * @property {NamedNode[]} [aggregation]
 * @property {NamedNode[]} [composition]
 * @property {archimate_Grouping[]} [influence]
 * @property {?archimate_Grouping} [realization]
 * @property {NamedNode[]} [serving]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Grouping_Props_Int} archimate_Grouping_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#ImplementationEvent
 */
class archimate_ImplementationEvent extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_ImplementationEvent'] = archimate_ImplementationEvent;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#ImplementationEvent
 * @typedef archimate_ImplementationEvent_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_ImplementationEvent_Props_Int} archimate_ImplementationEvent_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Material
 */
class archimate_Material extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Material'] = archimate_Material;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Material
 * @typedef archimate_Material_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Material_Props_Int} archimate_Material_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Meaning
 */
class archimate_Meaning extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Meaning'] = archimate_Meaning;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Meaning
 * @typedef archimate_Meaning_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Meaning_Props_Int} archimate_Meaning_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Node
 */
class archimate_Node extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Node'] = archimate_Node;
Object.defineProperty(archimate_Node.prototype, 'association', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#association>', archimate_CommunicationNetwork);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#association', value, null);
	}
});
Object.defineProperty(archimate_Node.prototype, 'composition', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#composition>', archimate_SystemSoftware);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#composition', values, null);
	}
});
Object.defineProperty(archimate_Node.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#realization>', archimate_TechnologyService);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', value, null);
	}
});
Object.defineProperty(archimate_Node.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#specialization>', archimate_Node);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', value, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Node
 * @typedef archimate_Node_Props_Int
 * @property {?archimate_CommunicationNetwork} [association]
 * @property {archimate_SystemSoftware[]} [composition]
 * @property {?archimate_TechnologyService} [realization]
 * @property {?archimate_Node} [specialization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Node_Props_Int} archimate_Node_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Outcome
 */
class archimate_Outcome extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Outcome'] = archimate_Outcome;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Outcome
 * @typedef archimate_Outcome_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Outcome_Props_Int} archimate_Outcome_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Path
 */
class archimate_Path extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Path'] = archimate_Path;
Object.defineProperty(archimate_Path.prototype, 'association', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#association>', null);
	},
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Path
 * @typedef archimate_Path_Props_Int
 * @property {NamedNode[]} [association]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Path_Props_Int} archimate_Path_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Plateau
 */
class archimate_Plateau extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Plateau'] = archimate_Plateau;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Plateau
 * @typedef archimate_Plateau_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Plateau_Props_Int} archimate_Plateau_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Principle
 */
class archimate_Principle extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Principle'] = archimate_Principle;
Object.defineProperty(archimate_Principle.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#aggregation>', archimate_Principle);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', value, null);
	}
});
Object.defineProperty(archimate_Principle.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#realization>', archimate_Goal);
	},
...
Object.defineProperty(archimate_Principle.prototype, 'specialization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#specialization>', archimate_Principle);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#specialization', values, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Principle
 * @typedef archimate_Principle_Props_Int
 * @property {?archimate_Principle} [aggregation]
 * @property {?archimate_Goal} [realization]
 * @property {archimate_Principle[]} [specialization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Principle_Props_Int} archimate_Principle_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Product
 */
class archimate_Product extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Product'] = archimate_Product;
Object.defineProperty(archimate_Product.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', archimate_BusinessService);
	},
...
Object.defineProperty(archimate_Product.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#serving>', archimate_BusinessRole);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#serving', values, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Product
 * @typedef archimate_Product_Props_Int
 * @property {archimate_BusinessService[]} [aggregation]
 * @property {archimate_BusinessRole[]} [serving]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Product_Props_Int} archimate_Product_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Representation
 */
class archimate_Representation extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Representation'] = archimate_Representation;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Representation
 * @typedef archimate_Representation_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Representation_Props_Int} archimate_Representation_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Requirement
 */
class archimate_Requirement extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_Requirement'] = archimate_Requirement;
Object.defineProperty(archimate_Requirement.prototype, 'influence', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#influence>', archimate_Assessment);
	},
...
Object.defineProperty(archimate_Requirement.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#realization>', archimate_Goal);
	},
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Requirement
 * @typedef archimate_Requirement_Props_Int
 * @property {?archimate_Assessment} [influence]
 * @property {?archimate_Goal} [realization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Requirement_Props_Int} archimate_Requirement_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Resource
 */
class archimate_Resource extends archimate_ArchimateModelElement {
	...
	/**
	 * (No sh:description found)
	 * The RDF path is ^<http://www.w3.org/1999/02/22-rdf-syntax-ns#object>
	 * @returns {?NamedNode}
	 */
	get objectInverse() {
	}
	
	set objectInverse(value) {
	}
...
GraphNodeUtil.classes['archimate_Resource'] = archimate_Resource;
Object.defineProperty(archimate_Resource.prototype, 'objectInverse', {
	enumerable: true,
	get() {
		return this.value('^<http://www.w3.org/1999/02/22-rdf-syntax-ns#object>', NamedNode);
	},
	set(value) {
		__jenaData.setPropertyValueInverse(this.zzzJenaNode, 'http://www.w3.org/1999/02/22-rdf-syntax-ns#object', value);
	}
});
Object.defineProperty(archimate_Resource.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#realization>', archimate_CourseOfAction);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#realization', value, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Resource
 * @typedef archimate_Resource_Props_Int
 * @property {?NamedNode} [objectInverse]
 * @property {?archimate_CourseOfAction} [realization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Resource_Props_Int} archimate_Resource_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Stakeholder
 */
class archimate_Stakeholder extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Stakeholder'] = archimate_Stakeholder;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Stakeholder
 * @typedef archimate_Stakeholder_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Stakeholder_Props_Int} archimate_Stakeholder_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#SystemSoftware
 */
class archimate_SystemSoftware extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_SystemSoftware'] = archimate_SystemSoftware;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#SystemSoftware
 * @typedef archimate_SystemSoftware_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_SystemSoftware_Props_Int} archimate_SystemSoftware_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#TechnologyCollaboration
 */
class archimate_TechnologyCollaboration extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_TechnologyCollaboration'] = archimate_TechnologyCollaboration;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#TechnologyCollaboration
 * @typedef archimate_TechnologyCollaboration_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_TechnologyCollaboration_Props_Int} archimate_TechnologyCollaboration_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#TechnologyEvent
 */
class archimate_TechnologyEvent extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_TechnologyEvent'] = archimate_TechnologyEvent;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#TechnologyEvent
 * @typedef archimate_TechnologyEvent_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_TechnologyEvent_Props_Int} archimate_TechnologyEvent_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#TechnologyFunction
 */
class archimate_TechnologyFunction extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_TechnologyFunction'] = archimate_TechnologyFunction;
Object.defineProperty(archimate_TechnologyFunction.prototype, 'realization', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#realization>', archimate_TechnologyService);
	},
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#TechnologyFunction
 * @typedef archimate_TechnologyFunction_Props_Int
 * @property {archimate_TechnologyService[]} [realization]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_TechnologyFunction_Props_Int} archimate_TechnologyFunction_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#TechnologyInteraction
 */
class archimate_TechnologyInteraction extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_TechnologyInteraction'] = archimate_TechnologyInteraction;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#TechnologyInteraction
 * @typedef archimate_TechnologyInteraction_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_TechnologyInteraction_Props_Int} archimate_TechnologyInteraction_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#TechnologyInterface
 */
class archimate_TechnologyInterface extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_TechnologyInterface'] = archimate_TechnologyInterface;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#TechnologyInterface
 * @typedef archimate_TechnologyInterface_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_TechnologyInterface_Props_Int} archimate_TechnologyInterface_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#TechnologyProcess
 */
class archimate_TechnologyProcess extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_TechnologyProcess'] = archimate_TechnologyProcess;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#TechnologyProcess
 * @typedef archimate_TechnologyProcess_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_TechnologyProcess_Props_Int} archimate_TechnologyProcess_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#TechnologyService
 */
class archimate_TechnologyService extends archimate_ArchimateModelElement {
...
GraphNodeUtil.classes['archimate_TechnologyService'] = archimate_TechnologyService;
Object.defineProperty(archimate_TechnologyService.prototype, 'aggregation', {
	enumerable: true,
	get() {
		return this.values('<http://bp4mc2.org/def/archimate#aggregation>', archimate_TechnologyService);
	},
	set(values) {
		__jenaData[Array.isArray(values) ? 'setPropertyValues' : 'setPropertyValue'](this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#aggregation', values, null);
	}
});
Object.defineProperty(archimate_TechnologyService.prototype, 'serving', {
	enumerable: true,
	get() {
		return this.value('<http://bp4mc2.org/def/archimate#serving>', null);
	},
	set(value) {
		__jenaData.setPropertyValue(this.zzzJenaNode, 'http://bp4mc2.org/def/archimate#serving', value, null);
	}
...
/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#TechnologyService
 * @typedef archimate_TechnologyService_Props_Int
 * @property {archimate_TechnologyService[]} [aggregation]
 * @property {?NamedNode} [serving]
 * @typedef {archimate_ArchimateModelElement_Props & archimate_TechnologyService_Props_Int} archimate_TechnologyService_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#Value
 */
class archimate_Value extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_Value'] = archimate_Value;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#Value
 * @typedef archimate_Value_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_Value_Props_Int} archimate_Value_Props
 */

/**
 * Generated from the shape http://bp4mc2.org/def/archimate#WorkPackage
 */
class archimate_WorkPackage extends archimate_ArchimateModelElement {

	constructor(obj) {
		super(typeof obj == 'string' ? { uri: obj } : obj);
	}
}
GraphNodeUtil.classes['archimate_WorkPackage'] = archimate_WorkPackage;

/**
 * Describes the properties of instances of http://bp4mc2.org/def/archimate#WorkPackage
 * @typedef archimate_WorkPackage_Props_Int
 * @typedef {archimate_ArchimateModelElement_Props & archimate_WorkPackage_Props_Int} archimate_WorkPackage_Props
 */
...
const SHAPES_GRAPH_ID = 'ontologie_archimate';
...
export {
	...
	archimate_CommunicationNetwork,
	...
	archimate_TechnologyCollaboration,
	archimate_TechnologyEvent,
	archimate_TechnologyFunction,
	archimate_TechnologyInteraction,
	archimate_TechnologyInterface,
	archimate_TechnologyProcess,
	...
	skosthes,
	skosthes_ConceptGroup,
	skosthes_ThesaurusArray,
	skosxl,
	skosxl_Label,
	smf,
	sparql,
